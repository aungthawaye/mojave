...
public class PutTransfersEvent extends DomainEvent<HandlePutTransfersResponseCommand.Input> {

    public PutTransfersEvent(HandlePutTransfersResponseCommand.Input payload) {
