...
public class ConnectorGatewayApplication {
    ...
    public static ConfigurableApplicationContext run(String[] args,
        ...
        if (extraConfigurations.length > 0) {
            System.arraycopy(
                coreConfigurations, 0, fullConfigurations, 0, coreConfigurations.length);
            System.arraycopy(
                extraConfigurations, 0, fullConfigurations, coreConfigurations.length,
                extraConfigurations.length);
        }
