...
@Service
public class RequestQuotesCommandHandler implements RequestQuotesCommand {
    ...
    public RequestQuotesCommandHandler(PostQuotes postQuotes, PubSubClient pubSubClient) {
