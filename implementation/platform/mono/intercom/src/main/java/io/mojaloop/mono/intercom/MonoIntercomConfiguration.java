...
import io.mojaloop.core.accounting.intercom.AccountingIntercomConfiguration;
...
import io.mojaloop.core.participant.intercom.ParticipantIntercomConfiguration;
...
import io.mojaloop.core.wallet.intercom.WalletIntercomConfiguration;
...
@EnableAsync
@ComponentScan(
    basePackages = {"io.mojaloop.mono.intercom.controller"})
@Import(
    value = {
