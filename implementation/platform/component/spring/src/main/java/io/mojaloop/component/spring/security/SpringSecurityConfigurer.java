...
package io.mojaloop.component.spring.security;
...
public class SpringSecurityConfigurer {
    ...
    public static SecurityFilterChain configure(HttpSecurity http,
        ...
        if (settings.securedEndpoints() != null) {

            http.authorizeHttpRequests(authorize -> authorize.requestMatchers(settings.securedEndpoints()).authenticated());
        }
