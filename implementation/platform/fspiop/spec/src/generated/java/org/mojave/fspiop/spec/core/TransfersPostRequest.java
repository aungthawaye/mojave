...
public class TransfersPostRequest {
    ...
    @JsonCreator
    public TransfersPostRequest(@JsonProperty(
        required = true,
        value = "transferId") String transferId, @JsonProperty(
        required = true,
        value = "payeeFsp") String payeeFsp, @JsonProperty(
        required = true,
        value = "payerFsp") String payerFsp, @JsonProperty(
        required = true,
        value = "amount") Money amount, @JsonProperty(
        required = true,
        value = "ilpPacket") String ilpPacket, @JsonProperty(
        required = true,
        value = "condition") String condition, @JsonProperty(
        required = true,
