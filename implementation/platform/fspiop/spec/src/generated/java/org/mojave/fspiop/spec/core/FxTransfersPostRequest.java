...
public class FxTransfersPostRequest {
    ...
    @JsonCreator
    public FxTransfersPostRequest(@JsonProperty(
        required = true,
        value = "commitRequestId") String commitRequestId, @JsonProperty(
        required = true,
        value = "initiatingFsp") String initiatingFsp, @JsonProperty(
        required = true,
        value = "counterPartyFsp") String counterPartyFsp, @JsonProperty(
        required = true,
        value = "sourceAmount") Money sourceAmount, @JsonProperty(
        required = true,
        value = "targetAmount") Money targetAmount, @JsonProperty(
        required = true,
