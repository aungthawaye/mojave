...
public class FxConversion {
    ...
    @JsonCreator
    public FxConversion(@JsonProperty(
        required = true,
        value = "conversionId") String conversionId, @JsonProperty(
        required = true,
        value = "initiatingFsp") String initiatingFsp, @JsonProperty(
        required = true,
        value = "counterPartyFsp") String counterPartyFsp, @JsonProperty(
        required = true,
        value = "amountType") AmountType amountType, @JsonProperty(
        required = true,
        value = "sourceAmount") FxMoney sourceAmount, @JsonProperty(
        required = true,
        value = "targetAmount") FxMoney targetAmount, @JsonProperty(
        required = true,
    ...
    @Size(
        min = 0,
        max = 16)
    public List<@Valid FxCharge> getCharges() {
