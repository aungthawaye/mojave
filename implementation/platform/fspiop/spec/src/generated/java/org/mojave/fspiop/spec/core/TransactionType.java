...
public class TransactionType {
    ...
    @JsonCreator
    public TransactionType(@JsonProperty(
        required = true,
        value = "scenario") TransactionScenario scenario, @JsonProperty(
        required = true,
        value = "initiator") TransactionInitiator initiator, @JsonProperty(
        required = true,
