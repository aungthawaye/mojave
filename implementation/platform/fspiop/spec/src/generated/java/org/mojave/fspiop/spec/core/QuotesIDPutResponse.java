...
public class QuotesIDPutResponse {
    ...
    @JsonCreator
    public QuotesIDPutResponse(@JsonProperty(
        required = true,
        value = "transferAmount") Money transferAmount, @JsonProperty(
        required = true,
        value = "expiration") String expiration, @JsonProperty(
        required = true,
        value = "ilpPacket") String ilpPacket, @JsonProperty(
        required = true,
    ...
    public int hashCode() {
        ...
        return Objects.hash(
            transferAmount, payeeReceiveAmount, payeeFspFee, payeeFspCommission,
            expiration, geoCode, ilpPacket, condition, extensionList);
    }
