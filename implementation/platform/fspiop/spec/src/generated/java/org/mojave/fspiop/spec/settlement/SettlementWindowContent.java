...
@jakarta.annotation.Generated(
    ...
    date = "2025-12-10T17:04:17.313326+06:30[Asia/Rangoon]",
...
public class SettlementWindowContent {
    ...
    @JsonCreator
    public SettlementWindowContent(@JsonProperty(
        required = true,
        value = "id") Integer id, @JsonProperty(
        required = true,
        value = "state") String state, @JsonProperty(
        required = true,
        value = "ledgerAccountType") String ledgerAccountType, @JsonProperty(
        required = true,
        value = "currencyId") String currencyId, @JsonProperty(
        required = true,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, settlementWindowContent.id) &&
                   ...
                   Objects.equals(
                       this.ledgerAccountType, settlementWindowContent.ledgerAccountType) &&
