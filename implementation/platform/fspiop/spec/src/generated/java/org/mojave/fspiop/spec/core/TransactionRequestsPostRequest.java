...
public class TransactionRequestsPostRequest {
    ...
    @JsonCreator
    public TransactionRequestsPostRequest(@JsonProperty(
        required = true,
        value = "transactionRequestId") String transactionRequestId, @JsonProperty(
        required = true,
        value = "payee") Party payee, @JsonProperty(
        required = true,
        value = "payer") PartyIdInfo payer, @JsonProperty(
        required = true,
