...
public class BulkQuotesPostRequest {
    ...
    @JsonCreator
    public BulkQuotesPostRequest(@JsonProperty(
                                     required = true,
                                     value = "bulkQuoteId") String bulkQuoteId,
                                 @JsonProperty(
                                     required = true,
                                     value = "payer") Party payer,
                                 @JsonProperty(
                                     required = true,
                                     value = "individualQuotes")
                                 List<@Valid IndividualQuote> individualQuotes) {
    ...
    @Size(
        min = 1,
        max = 1000)
    public List<@Valid IndividualQuote> getIndividualQuotes() {
