...
public class ServicesFXPSourceCurrencyTargetCurrencyPutResponse {
    ...
    private @Valid List<@Size(
        min = 1,
        max = 32) String> providers = new ArrayList<>();
    ...
    @JsonCreator
    public ServicesFXPSourceCurrencyTargetCurrencyPutResponse(@JsonProperty(
        required = true,
    ...
    @JsonProperty(
        required = true,
        value = "providers")
    public void setProviders(List<@Size(
        min = 1,
        max = 32) String> providers) {
     ...
     **/
    public ServicesFXPSourceCurrencyTargetCurrencyPutResponse providers(List<@Size(
        min = 1,
        max = 32) String> providers) {
