...
public class BulkTransfersPostRequest {
    ...
    @Valid
    @Size(min = 1, max = 1000)
    public List<@Valid IndividualTransfer> getIndividualTransfers() {
    ...
    public String toString() {
        ...
        String sb = "class BulkTransfersPostRequest {\n" +
                        "    bulkTransferId: " + toIndentedString(bulkTransferId) + "\n" +
                        "    bulkQuoteId: " + toIndentedString(bulkQuoteId) + "\n" +
                        "    payerFsp: " + toIndentedString(payerFsp) + "\n" +
                        "    payeeFsp: " + toIndentedString(payeeFsp) + "\n" +
                        "    individualTransfers: " + toIndentedString(individualTransfers) + "\n" +
