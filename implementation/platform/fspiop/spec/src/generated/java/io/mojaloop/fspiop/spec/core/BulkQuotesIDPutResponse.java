...
public class BulkQuotesIDPutResponse {
    ...
    @Valid
    @Size(max = 1000)
    public List<@Valid IndividualQuoteResult> getIndividualQuoteResults() {
    ...
    public String toString() {
        ...
        String sb = "class BulkQuotesIDPutResponse {\n" +
                        "    individualQuoteResults: " + toIndentedString(individualQuoteResults) + "\n" +
