...
public class SettlementWindowContent {
    ...
    public String toString() {
        ...
        String sb = "class SettlementWindowContent {\n" +
                        "    id: " + toIndentedString(id) + "\n" +
                        "    state: " + toIndentedString(state) + "\n" +
                        "    ledgerAccountType: " + toIndentedString(ledgerAccountType) + "\n" +
                        "    currencyId: " + toIndentedString(currencyId) + "\n" +
                        "    createdDate: " + toIndentedString(createdDate) + "\n" +
                        "    changedDate: " + toIndentedString(changedDate) + "\n" +
                        "    settlementId: " + toIndentedString(settlementId) + "\n" +
                        "}";
        return sb;
    }
