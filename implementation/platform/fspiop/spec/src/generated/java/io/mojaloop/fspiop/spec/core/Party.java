...
public class Party {
    ...
    public String toString() {
        ...
        String sb = "class Party {\n" +
                        "    partyIdInfo: " + toIndentedString(partyIdInfo) + "\n" +
                        "    merchantClassificationCode: " + toIndentedString(merchantClassificationCode) + "\n" +
                        "    name: " + toIndentedString(name) + "\n" +
                        "    personalInfo: " + toIndentedString(personalInfo) + "\n" +
