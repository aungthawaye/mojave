...
public class BulkTransfersIDPutResponse {
    ...
    public String toString() {
        ...
        String sb = "class BulkTransfersIDPutResponse {\n" +
                        "    completedTimestamp: " + toIndentedString(completedTimestamp) + "\n" +
                        "    individualTransferResults: " + toIndentedString(individualTransferResults) + "\n" +
                        "    bulkTransferState: " + toIndentedString(bulkTransferState) + "\n" +
