...
public class RespondPartiesHandler implements RespondParties {
    ...
    public RespondPartiesHandler(ParticipantDetails participantDetails,
    ...
    @Override
    public void putParties(Destination destination, String url, PartiesTypeIDPutResponse response) throws FspiopException {

        try {

            var fspiopHeaders = FspiopHeaders.Values.Parties.forResult(this.participantDetails.fspCode(), destination.destinationFspCode());
    ...
    @Override
    public void putPartiesError(Destination destination, String url, ErrorInformationObject error) throws FspiopException {
