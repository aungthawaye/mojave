...
public class FspiopErrors {
    ...
    static {
        ...
        ERROR_MAP.put(
            DESTINATION_COMMUNICATION_ERROR.errorType().getCode(), DESTINATION_COMMUNICATION_ERROR);
        ...
        ERROR_MAP.put(
            SERVICE_CURRENTLY_UNAVAILABLE.errorType().getCode(), SERVICE_CURRENTLY_UNAVAILABLE);
        ...
        ERROR_MAP.put(
            UNACCEPTABLE_VERSION_REQUESTED.errorType().getCode(), UNACCEPTABLE_VERSION_REQUESTED);
        ERROR_MAP.put(UNKNOWN_URI.errorType().getCode(), UNKNOWN_URI);
        ERROR_MAP.put(
            ADD_PARTY_INFORMATION_ERROR.errorType().getCode(), ADD_PARTY_INFORMATION_ERROR);
        ...
        ERROR_MAP.put(
            MISSING_EXTENSION_PARAMETER.errorType().getCode(), MISSING_EXTENSION_PARAMETER);
        ...
        ERROR_MAP.put(
            TRANSACTION_REQUEST_ID_NOT_FOUND.errorType().getCode(),
        ...
        ERROR_MAP.put(
            TRANSACTION_REQUEST_EXPIRED.errorType().getCode(), TRANSACTION_REQUEST_EXPIRED);
        ...
        ERROR_MAP.put(
            PAYER_FSP_INSUFFICIENT_LIQUIDITY.errorType().getCode(),
            PAYER_FSP_INSUFFICIENT_LIQUIDITY);
        ERROR_MAP.put(GENERIC_PAYER_REJECTION.errorType().getCode(), GENERIC_PAYER_REJECTION);
        ERROR_MAP.put(
            PAYER_REJECTED_TRANSACTION_REQUEST.errorType().getCode(),
            PAYER_REJECTED_TRANSACTION_REQUEST);
        ERROR_MAP.put(
            PAYER_FSP_UNSUPPORTED_TRANSACTION_TYPE.errorType().getCode(),
        ...
        ERROR_MAP.put(
            GENERIC_PAYER_BLOCKED_ERROR.errorType().getCode(), GENERIC_PAYER_BLOCKED_ERROR);

        ERROR_MAP.put(GENERIC_PAYEE_ERROR.errorType().getCode(), GENERIC_PAYEE_ERROR);
        ERROR_MAP.put(
            PAYEE_FSP_INSUFFICIENT_LIQUIDITY.errorType().getCode(),
        ...
        ERROR_MAP.put(
            PAYEE_FSP_UNSUPPORTED_TRANSACTION_TYPE.errorType().getCode(),
        ...
        ERROR_MAP.put(
            PAYEE_FSP_REJECTED_TRANSACTION.errorType().getCode(), PAYEE_FSP_REJECTED_TRANSACTION);
        ...
        ERROR_MAP.put(
            GENERIC_PAYEE_BLOCKED_ERROR.errorType().getCode(), GENERIC_PAYEE_BLOCKED_ERROR);
    }
