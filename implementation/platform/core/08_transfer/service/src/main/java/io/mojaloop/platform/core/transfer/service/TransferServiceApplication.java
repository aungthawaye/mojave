...
public class TransferServiceApplication {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(TransferServiceApplication.class).web(WebApplicationType.SERVLET).properties(
            "spring.application.name=transfer-service", "spring.jmx.enabled=true", "spring.jmx.unique-types=true", "spring.jmx.default-domain=transfer-service",
            ...
            "spring.application.admin.jmx-name=org.springframework.boot:type=Admin,name=TransferServiceApplication,context=transfer-service").run(args);
    }
