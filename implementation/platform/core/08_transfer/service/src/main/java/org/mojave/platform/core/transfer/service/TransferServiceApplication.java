...
import org.mojave.core.transfer.TransferFlyway;
...
@Import(
    value = {
        ...
        TransferServiceDependencies.class,
        TransferServiceSettings.class})
public class TransferServiceApplication {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(TransferServiceApplication.class)
            .web(WebApplicationType.SERVLET)
            .properties(
                "spring.application.name=transfer-service", "spring.jmx.enabled=true",
    ...
    public WebServerFactoryCustomizer<ConfigurableWebServerFactory> webServerFactoryCustomizer(
        TransferServiceConfiguration.TomcatSettings settings) {
