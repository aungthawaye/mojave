 ...
 */
public interface RemoveFundInDefinitionPostingCommand {

    Output execute(Input input) throws FundInDefinitionPostingNotFoundException, FundInDefinitionNotFoundException;

    /**
     * Input for creating a Fund-In Definition.
     */
    record Input(@JsonProperty(required = true) @NotNull DefinitionId definitionId, @JsonProperty(required = true) @NotNull PostingId postingId) {
