...
/**
 * Command contract for changing currency of a Fund-In Definition.
 */
public interface ChangeFundInDefinitionCurrencyCommand {

    Output execute(Input input) throws FundInDefinitionNotFoundException, FundInDefinitionWithCurrencyExistsException;

    /**
     * Input specifying the definition to change currency.
     */
    record Input(@JsonProperty(required = true) @NotNull DefinitionId definitionId, @JsonProperty(required = true) @NotNull Currency currency) { }
