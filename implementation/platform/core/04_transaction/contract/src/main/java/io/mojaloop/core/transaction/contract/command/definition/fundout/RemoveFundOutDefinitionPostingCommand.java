...
/**
 * Command contract for removing a posting from a Fund-Out Definition.
 */
public interface RemoveFundOutDefinitionPostingCommand {

    Output execute(Input input) throws FundOutDefinitionPostingNotFoundException, FundOutDefinitionNotFoundException;
