...
/**
 * Command contract for terminating a Fund-In Definition.
 */
public interface TerminateFundInDefinitionCommand {

    Output execute(Input input) throws FundInDefinitionNotFoundException;
