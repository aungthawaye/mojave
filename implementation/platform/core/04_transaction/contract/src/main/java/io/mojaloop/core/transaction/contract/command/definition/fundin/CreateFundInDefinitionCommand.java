 ...
 */
public interface CreateFundInDefinitionCommand {

    Output execute(Input input) throws PostingAlreadyExistsException, FundInDefinitionWithCurrencyExistsException, FundInDefinitionNameTakenException;
