...
/**
 * Command contract for adding postings to a Fund-Transfer Definition.
 */
public interface AddFundTransferDefinitionPostingCommand {

    Output execute(Input input) throws PostingAlreadyExistsException, FundTransferDefinitionNotFoundException;

    /**
     * Input for adding postings to a Fund-Transfer Definition.
     */
