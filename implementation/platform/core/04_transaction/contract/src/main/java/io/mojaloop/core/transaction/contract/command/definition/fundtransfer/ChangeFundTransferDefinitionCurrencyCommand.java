...
/**
 * Command contract for changing currency of a Fund-Transfer Definition.
 *
 */
public interface ChangeFundTransferDefinitionCurrencyCommand {

    Output execute(Input input) throws FundTransferDefinitionNotFoundException, FundTransferDefinitionWithCurrencyExistsException;
