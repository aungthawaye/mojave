...
/**
 * Command contract for changing currency of a Fund-Out Definition.
 */
public interface ChangeFundOutDefinitionCurrencyCommand {

    Output execute(Input input) throws FundOutDefinitionNotFoundException, FundOutDefinitionWithCurrencyExistsException;
