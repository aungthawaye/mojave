...
/**
 * Command contract for creating a Fund-Transfer Definition.
 */
public interface CreateFundTransferDefinitionCommand {

    Output execute(Input input) throws PostingAlreadyExistsException,
            FundTransferDefinitionWithCurrencyExistsException,
            FundTransferDefinitionNameTakenException;

    /**
     * Input for creating a Fund-Transfer Definition.
     */
     ...
     */
    record Output(DefinitionId definitionId, java.util.List<PostingId> postingIds) { }
}
