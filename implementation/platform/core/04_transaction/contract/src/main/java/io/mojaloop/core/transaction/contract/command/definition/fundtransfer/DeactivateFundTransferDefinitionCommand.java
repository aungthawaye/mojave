...
/**
 * Command contract for deactivating a Fund-Transfer Definition.
 */
public interface DeactivateFundTransferDefinitionCommand {

    Output execute(Input input) throws FundTransferDefinitionNotFoundException;
