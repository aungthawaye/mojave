...
/**
 * Command contract for adding postings to a Fund-Out Definition.
 */
public interface AddFundOutDefinitionPostingCommand {

    Output execute(Input input) throws PostingAlreadyExistsException, FundOutDefinitionNotFoundException;

    /**
     * Input for adding postings to a Fund-Out Definition.
     */
