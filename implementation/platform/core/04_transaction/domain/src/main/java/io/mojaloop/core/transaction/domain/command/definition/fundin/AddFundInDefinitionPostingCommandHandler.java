...
@Service
public class AddFundInDefinitionPostingCommandHandler implements AddFundInDefinitionPostingCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(AddFundInDefinitionPostingCommandHandler.class);

    private final FundInDefinitionRepository fundInDefinitionRepository;

    public AddFundInDefinitionPostingCommandHandler(FundInDefinitionRepository fundInDefinitionRepository) {
    ...
    @Transactional
    @Write
    public Output execute(Input input) throws PostingAlreadyExistsException, FundInDefinitionNotFoundException {

        LOGGER.info("Executing AddFundInDefinitionPostingCommand with input: {}", input);
        ...
        LOGGER.info("Completed AddFundInDefinitionPostingCommand with input: {}", input);
