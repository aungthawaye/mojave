...
@Service
public class DeactivateFundTransferDefinitionCommandHandler implements DeactivateFundTransferDefinitionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeactivateFundTransferDefinitionCommandHandler.class);

    private final FundTransferDefinitionRepository fundTransferDefinitionRepository;

    public DeactivateFundTransferDefinitionCommandHandler(FundTransferDefinitionRepository fundTransferDefinitionRepository) {
    ...
    public Output execute(Input input) throws FundTransferDefinitionNotFoundException {
        ...
        LOGGER.info("Executing DeactivateFundTransferDefinitionCommand with input: {}", input);
        ...
        LOGGER.info("Completed DeactivateFundTransferDefinitionCommand with input: {}", input);
