...
public class FundOutDefinition extends JpaEntity<DefinitionId> implements DataConversion<FundOutDefinitionData> {
    ...
    public FundOutDefinition(Currency currency, String name, String description) {
    ...
    public FundOutDefinition description(String description) {
    ...
    public FundOutDefinition name(String name) {
    ...
    @Getter
    @Entity
    @Table(name = "txn_fund_out_posting")
    @NoArgsConstructor(access = AccessLevel.PROTECTED)
