...
@Service
public class DeactivateFundInDefinitionCommandHandler implements DeactivateFundInDefinitionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeactivateFundInDefinitionCommandHandler.class);

    private final FundInDefinitionRepository fundInDefinitionRepository;

    public DeactivateFundInDefinitionCommandHandler(FundInDefinitionRepository fundInDefinitionRepository) {
    ...
    public Output execute(Input input) throws FundInDefinitionNotFoundException {
        ...
        LOGGER.info("Executing DeactivateFundInDefinitionCommand with input: {}", input);
        ...
        LOGGER.info("Completed DeactivateFundInDefinitionCommand with input: {}", input);
