...
@Service
public class TerminateFundOutDefinitionCommandHandler implements TerminateFundOutDefinitionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(TerminateFundOutDefinitionCommandHandler.class);

    private final FundOutDefinitionRepository fundOutDefinitionRepository;

    public TerminateFundOutDefinitionCommandHandler(FundOutDefinitionRepository fundOutDefinitionRepository) {
    ...
    public Output execute(Input input) throws FundOutDefinitionNotFoundException {
        ...
        LOGGER.info("Executing TerminateFundOutDefinitionCommand with input: {}", input);
        ...
        LOGGER.info("Completed TerminateFundOutDefinitionCommand with input: {}", input);
