...
@Service
public class ActivateFundTransferDefinitionCommandHandler implements ActivateFundTransferDefinitionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateFundTransferDefinitionCommandHandler.class);

    private final FundTransferDefinitionRepository fundTransferDefinitionRepository;

    public ActivateFundTransferDefinitionCommandHandler(FundTransferDefinitionRepository fundTransferDefinitionRepository) {
    ...
    public Output execute(Input input) throws FundTransferDefinitionNotFoundException {
        ...
        LOGGER.info("Executing ActivateFundTransferDefinitionCommand with input: {}", input);
        ...
        LOGGER.info("Completed ActivateFundTransferDefinitionCommand with input: {}", input);
