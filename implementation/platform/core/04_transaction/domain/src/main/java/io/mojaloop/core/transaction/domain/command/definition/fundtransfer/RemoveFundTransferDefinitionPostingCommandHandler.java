...
@Service
public class RemoveFundTransferDefinitionPostingCommandHandler implements RemoveFundTransferDefinitionPostingCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(RemoveFundTransferDefinitionPostingCommandHandler.class);

    private final FundTransferDefinitionRepository fundTransferDefinitionRepository;

    public RemoveFundTransferDefinitionPostingCommandHandler(FundTransferDefinitionRepository fundTransferDefinitionRepository) {
    ...
    @Transactional
    @Write
    public Output execute(Input input) throws FundTransferDefinitionPostingNotFoundException, FundTransferDefinitionNotFoundException {

        LOGGER.info("Executing RemoveFundTransferDefinitionPostingCommand with input: {}", input);
        ...
        LOGGER.info("Completed RemoveFundTransferDefinitionPostingCommand with input: {}", input);
