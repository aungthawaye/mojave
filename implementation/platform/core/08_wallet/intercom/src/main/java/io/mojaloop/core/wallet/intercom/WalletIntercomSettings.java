...
final class WalletIntercomSettings implements WalletIntercomConfiguration.RequiredSettings {
    ...
    public MySqlBalanceUpdater.BalanceDbSettings balanceDbSettings() {
        ...
        return new MySqlBalanceUpdater.BalanceDbSettings(new MySqlBalanceUpdater.BalanceDbSettings.Connection(System.getenv().getOrDefault("WLT_BALANCE_DB_URL",
                                                                                                                                           "jdbc:mysql://localhost:3306/ml_wallet?createDatabaseIfNotExist=true"),
                                                                                                              System.getenv().getOrDefault("WLT_BALANCE_DB_USER", "root"),
                                                                                                              System.getenv().getOrDefault("WLT_BALANCE_DB_PASSWORD", "password")),
    ...
    public MySqlPositionUpdater.PositionDbSettings positionDbSettings() {
        ...
        return new MySqlPositionUpdater.PositionDbSettings(new MySqlPositionUpdater.PositionDbSettings.Connection(System.getenv().getOrDefault("WLT_POSITION_DB_URL",
                                                                                                                                               "jdbc:mysql://localhost:3306/ml_wallet?createDatabaseIfNotExist=true"),
                                                                                                                  System.getenv().getOrDefault("WLT_POSITION_DB_USER", "root"),
                                                                                                                  System.getenv()
                                                                                                                        .getOrDefault("WLT_POSITION_DB_PASSWORD", "password")),
    ...
    public RoutingDataSourceConfigurer.ReadSettings routingDataSourceReadSettings() {
        ...
        var pool = new RoutingDataSourceConfigurer.ReadSettings.Pool("wallet-intercom-read",
    ...
    public RoutingDataSourceConfigurer.WriteSettings routingDataSourceWriteSettings() {
        ...
        var pool = new RoutingDataSourceConfigurer.WriteSettings.Pool("wallet-intercom-write",
