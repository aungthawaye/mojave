...
public class WalletIntercomApplication {
    ...
    public static void main(String[] args) {
        ...
        var flywaySettings = new FlywayMigration.Settings(System.getenv().getOrDefault("WLT_FLYWAY_DB_URL",
                                                          ...
                                                          System.getenv().getOrDefault("WLT_FLYWAY_DB_PASSWORD", "password"),
        ...
        new SpringApplicationBuilder(WalletIntercomApplication.class).web(WebApplicationType.SERVLET).properties("spring.application.name=wallet-intercom",
                                                                                                                 "spring.jmx.enabled=true",
                                                                                                                 "spring.jmx.unique-types=true",
                                                                                                                 "spring.jmx.default-domain=wallet-intercom",
