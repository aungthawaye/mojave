...
@Component
public class RollbackPosition {

    private static final Logger LOGGER = LoggerFactory.getLogger(RollbackPosition.class);

    private final WalletIntercomService walletIntercomService;

    private final ObjectMapper objectMapper;

    public RollbackPosition(final WalletIntercomService walletIntercomService, final ObjectMapper objectMapper) {
    ...
    public RollbackPositionCommand.Output execute(final RollbackPositionCommand.Input input) throws WalletIntercomClientException {
        ...
        try {
            ...
            LOGGER.error("Error invoking rollbackPosition : {}", e.getMessage());
