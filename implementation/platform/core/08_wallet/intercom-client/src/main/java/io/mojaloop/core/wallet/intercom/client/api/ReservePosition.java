...
public class ReservePosition {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ReservePosition.class);

    private final WalletIntercomService walletIntercomService;

    private final ObjectMapper objectMapper;

    public ReservePosition(final WalletIntercomService walletIntercomService, final ObjectMapper objectMapper) {
    ...
    public ReservePositionCommand.Output execute(final ReservePositionCommand.Input input) throws WalletIntercomClientException {
        ...
        try {
            ...
            LOGGER.error("Error invoking reservePosition : {}", e.getMessage());
