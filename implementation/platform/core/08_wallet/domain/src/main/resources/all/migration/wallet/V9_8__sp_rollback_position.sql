...
BEGIN
    ...
    SELECT position_id,
           ...
           description
    INTO
        v_position_id, v_amount, v_transaction_id, v_transaction_at, v_action, v_description
    ...
    SELECT position,
           ...
           currency
    INTO
        v_old_position, v_old_reserved, v_net_debit_cap, v_currency
    FROM wlt_position
    ...
    UPDATE wlt_position SET reserved = v_new_reserved WHERE position_id = v_position_id;
    ...
    INSERT INTO wlt_position_update (position_update_id,
                                     ...
                                     rec_updated_at,
                                     rec_version)
    VALUES (p_position_update_id, v_position_id,
            'ROLLBACK', v_transaction_id, v_currency,
            v_amount, v_old_position, v_old_position,
            v_old_reserved, v_new_reserved, v_net_debit_cap,
            v_description, v_transaction_at, v_now, p_reservation_id,
            v_now, v_now, 0);
    COMMIT;
