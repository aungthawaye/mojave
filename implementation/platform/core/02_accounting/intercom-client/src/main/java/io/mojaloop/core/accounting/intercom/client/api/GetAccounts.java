...
public class GetAccounts {
    ...
    public List<AccountData> execute() throws AccountingIntercomClientException {
        ...
        try {
            ...
            return RetrofitService.invoke(this.accountingIntercomService.getAccounts(), (status, errorResponseBody) -> RestErrorResponse.decode(errorResponseBody, objectMapper))
                                  .body();
