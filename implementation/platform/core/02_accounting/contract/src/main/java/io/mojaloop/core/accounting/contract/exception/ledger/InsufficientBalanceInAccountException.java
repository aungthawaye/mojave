...
public class InsufficientBalanceInAccountException extends CheckedDomainException {
    ...
    public InsufficientBalanceInAccountException(final AccountCode accountCode,
                                                 final Side side,
    ...
    public static InsufficientBalanceInAccountException from(final Map<String, String> extras) {
        ...
        return new InsufficientBalanceInAccountException(accountCode, side, amount, postedDebits, postedCredits, transactionId);
    }
