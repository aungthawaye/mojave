...
public record ChartEntryData(ChartEntryId chartEntryId, ChartEntryCode code, String name, String description, AccountType accountType,
                             Instant createdAt, ChartId chartId) {
