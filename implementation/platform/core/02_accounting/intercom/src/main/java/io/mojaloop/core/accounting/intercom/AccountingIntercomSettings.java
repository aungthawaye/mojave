...
final class AccountingIntercomSettings implements AccountingIntercomConfiguration.RequiredSettings {
    ...
    public MySqlLedger.LedgerDbSettings ledgerDbSettings() {
        ...
        return new MySqlLedger.LedgerDbSettings(new MySqlLedger.LedgerDbSettings.Connection(System.getenv().getOrDefault("ACC_LEDGER_DB_URL",
    ...
    public RoutingDataSourceConfigurer.ReadSettings routingDataSourceReadSettings() {
        ...
        var pool = new RoutingDataSourceConfigurer.ReadSettings.Pool("accounting-intercom-read",
