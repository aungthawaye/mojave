...
public class AccountingIntercomApplication {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(AccountingIntercomApplication.class).web(WebApplicationType.SERVLET).properties(
            "spring.application.name=accounting-intercom", "spring.jmx.enabled=true", "spring.jmx.unique-types=true", "spring.jmx.default-domain=accounting-intercom",
            ...
            "spring.application.admin.jmx-name=org.springframework.boot:type=Admin,name=AccountingIntercomApplication,context=accounting-intercom").run(args);
    }
