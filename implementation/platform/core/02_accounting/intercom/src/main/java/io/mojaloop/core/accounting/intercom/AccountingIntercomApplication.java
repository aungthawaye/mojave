...
public class AccountingIntercomApplication {
    ...
    public static void main(String[] args) {
        ...
        var flywaySettings = new FlywayMigration.Settings(System.getenv().getOrDefault("ACC_FLYWAY_DB_URL",
        ...
        new SpringApplicationBuilder(AccountingIntercomApplication.class).web(WebApplicationType.SERVLET).properties("spring.application.name=accounting-intercom",
