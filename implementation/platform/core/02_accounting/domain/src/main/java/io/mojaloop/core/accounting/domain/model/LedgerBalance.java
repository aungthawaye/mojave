...
public class LedgerBalance extends JpaEntity<AccountId> implements DataConversion<LedgerBalanceData> {
    ...
    public LedgerBalanceData convert() {
        ...
        return new LedgerBalanceData(this.getId(), this.currency, this.scale, this.nature, this.postedDebits, this.postedCredits,
                                     this.overdraftMode, this.overdraftLimit, this.createdAt);
    }
