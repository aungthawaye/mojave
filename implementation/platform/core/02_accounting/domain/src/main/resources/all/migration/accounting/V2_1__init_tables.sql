...
(
    ...
    `side`                      varchar(32) NOT NULL,
    `account_resolving`         varchar(32) NOT NULL,
    `account_or_chart_entry_id` bigint      NOT NULL,
    `description`               varchar(256) DEFAULT NULL,
    ...
    UNIQUE KEY `acc_posting_definition_for_posting_UK` (`definition_id`, `participant_type`, `amount_name`, `side`,
                                                        `account_resolving`, `account_or_chart_entry_id`),
