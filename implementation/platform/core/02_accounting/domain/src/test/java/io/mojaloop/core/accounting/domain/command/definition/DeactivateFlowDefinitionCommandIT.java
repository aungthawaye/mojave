...
public class DeactivateFlowDefinitionCommandIT extends BaseDomainIT {
    ...
    @Test
    void should_deactivate_flow_definition_successfully() throws Exception {
        // Arrange
        ...
        this.createAccountCommand.execute(
            new CreateAccountCommand.Input(entry.chartEntryId(), new AccountOwnerId(3101L), Currency.USD, new AccountCode("ACC_ASSET"), "Asset Acc", "Test", OverdraftMode.FORBID,
                BigDecimal.ZERO));
    ...
    void should_fail_when_flow_definition_not_found() {
        // Arrange
        final var input = new DeactivateFlowDefinitionCommand.Input(new FlowDefinitionId(99999999L));
