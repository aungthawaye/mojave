...
public class ChangeFlowDefinitionCurrencyCommandIT extends BaseDomainIT {
    ...
    void should_fail_when_target_currency_conflicts() throws Exception {
        ...
        final var flowA = this.createFlowDefinitionCommand.execute(new CreateFlowDefinitionCommand.Input(TransactionType.FUND_IN,
                                                                                                         Currency.USD,
                                                                                                         "Flow I",
                                                                                                         "Desc",
                                                                                                         List.of(new CreateFlowDefinitionCommand.Input.Posting(ReceiveIn.CHART_ENTRY,
        ...
        final var flowB = this.createFlowDefinitionCommand.execute(new CreateFlowDefinitionCommand.Input(TransactionType.FUND_IN,
                                                                                                         Currency.EUR,
                                                                                                         "Flow J",
                                                                                                         "Desc",
                                                                                                         List.of(new CreateFlowDefinitionCommand.Input.Posting(ReceiveIn.CHART_ENTRY,
