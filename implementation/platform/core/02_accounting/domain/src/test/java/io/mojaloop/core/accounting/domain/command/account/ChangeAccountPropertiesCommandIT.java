...
public class ChangeAccountPropertiesCommandIT extends BaseDomainIT {
    ...
    void should_change_account_name_and_description_successfully() throws Exception {
        ...
        final var createInput = new CreateAccountCommand.Input(entryOut.chartEntryId(), new AccountOwnerId(2004L), Currency.USD,
                                                               new AccountCode("ACC006"), "Account", "Desc", OverdraftMode.FORBID,
                                                               BigDecimal.ZERO);
