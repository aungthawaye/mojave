...
public class AccountingAdminApplication {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(AccountingAdminApplication.class).web(WebApplicationType.SERVLET).properties(
            "spring.application.name=accounting-admin", "spring.jmx.enabled=true", "spring.jmx.unique-types=true", "spring.jmx.default-domain=accounting-admin",
            ...
            "spring.application.admin.jmx-name=org.springframework.boot:type=Admin,name=AccountingAdminApplication,context=accounting-admin").run(args);
    }
