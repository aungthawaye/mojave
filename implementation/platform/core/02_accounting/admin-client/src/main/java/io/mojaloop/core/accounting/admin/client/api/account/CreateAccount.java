...
public class CreateAccount {
    ...
    public CreateAccount(AccountingAdminService.AccountCommands accountCommands, ObjectMapper objectMapper) {
    ...
    public CreateAccountCommand.Output execute(CreateAccountCommand.Input input) throws AccountingAdminClientException {
        ...
        try {
            ...
            LOGGER.error("Error invoking createAccount : {}", e.getMessage());
