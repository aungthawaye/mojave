...
public class ChangeAccountPropertiesInvoker implements ChangeAccountPropertiesCommand {

    private final AccountingAdminService.AccountCommand accountCommand;

    private final ObjectMapper objectMapper;

    public ChangeAccountPropertiesInvoker(final AccountingAdminService.AccountCommand accountCommand, final ObjectMapper objectMapper) {
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(this.accountCommand.changeProperties(input), (status, errorResponseBody) -> RestErrorResponse.decode(errorResponseBody, this.objectMapper))
                                  .body();
