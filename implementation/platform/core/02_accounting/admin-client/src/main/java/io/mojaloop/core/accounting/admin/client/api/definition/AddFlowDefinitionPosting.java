...
@Component
public class AddFlowDefinitionPosting {

    private static final Logger LOGGER = LoggerFactory.getLogger(AddFlowDefinitionPosting.class);

    private final AccountingAdminService.DefinitionCommands definitionCommands;

    private final ObjectMapper objectMapper;

    public AddFlowDefinitionPosting(AccountingAdminService.DefinitionCommands definitionCommands, ObjectMapper objectMapper) {
    ...
    public void execute(AddPostingDefinitionCommand.Input input) throws AccountingAdminClientException {
        ...
        try {
            ...
            LOGGER.error("Error invoking addFlowDefinitionPostings : {}", e.getMessage());
