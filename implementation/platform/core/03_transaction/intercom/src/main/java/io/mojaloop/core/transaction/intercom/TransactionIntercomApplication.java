...
public class TransactionIntercomApplication {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(TransactionIntercomApplication.class).web(WebApplicationType.SERVLET).properties(
            "spring.application.name=transaction-intercom", "spring.jmx.enabled=true", "spring.jmx.unique-types=true", "spring.jmx.default-domain=transaction-intercom",
            ...
            "spring.application.admin.jmx-name=org.springframework.boot:type=Admin,name=TransactionIntercomApplication,context=transaction-intercom").run(args);
    }
