...
public class TestSettings implements TransactionConsumerConfiguration.RequiredSettings {
    ...
    public AddStepListener.Settings addStepListenerSettings() {
        ...
        return new AddStepListener.Settings("localhost:9092", AddStepListener.GROUP_ID, UUID.randomUUID().toString(), "earliest", 1, 100, false,
    ...
    public CloseTransactionListener.Settings closeTransactionListenerSettings() {
        ...
        return new CloseTransactionListener.Settings("localhost:9092", CloseTransactionListener.GROUP_ID, UUID.randomUUID().toString(), "earliest", 1, 100, false,
            ContainerProperties.AckMode.MANUAL);
    }
