...
public class TestSettings implements TransactionDomainConfiguration.RequiredSettings {
    ...
    public RoutingDataSourceConfigurer.ReadSettings routingDataSourceReadSettings() {
        ...
        return new RoutingDataSourceConfigurer.ReadSettings(new RoutingDataSourceConfigurer.ReadSettings.Connection(
            ...
            "root",
            "password",
            false), new RoutingDataSourceConfigurer.ReadSettings.Pool("transaction-read", 2, 4));
    }
    ...
    public RoutingDataSourceConfigurer.WriteSettings routingDataSourceWriteSettings() {
        ...
        return new RoutingDataSourceConfigurer.WriteSettings(new RoutingDataSourceConfigurer.WriteSettings.Connection(
            ...
            "root",
            "password",
            false), new RoutingDataSourceConfigurer.WriteSettings.Pool("transaction-write", 2, 4));
    }
