...
public class AddSupportedCurrencyIT {
    ...
    @Test
    public void test_successfully_add_supported_currency() throws ParticipantCommandClientException {
        ...
        this.addSupportedCurrency.execute(new AddSupportedCurrencyCommand.Input(new FspId(output.fspId().getId()), Currency.EUR));
    }
}
