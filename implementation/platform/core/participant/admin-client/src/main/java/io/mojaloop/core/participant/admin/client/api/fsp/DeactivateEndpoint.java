...
public class DeactivateEndpoint {
    ...
    public DeactivateEndpointCommand.Output execute(DeactivateEndpointCommand.Input input) throws ParticipantCommandClientException {

        try {

            return RetrofitService
                       .invoke(this.fspCommands.deactivateEndpoint(input), (status, errorResponseBody) -> RestErrorResponse.decode(errorResponseBody, this.objectMapper))
                       .body();
