...
@Component
public class AddHubCurrency {

    private static final Logger LOGGER = LoggerFactory.getLogger(AddHubCurrency.class);

    private final ParticipantAdminService.HubCommands hubCommands;

    private final ObjectMapper objectMapper;

    public AddHubCurrency(ParticipantAdminService.HubCommands hubCommands, ObjectMapper objectMapper) {
    ...
    public AddHubCurrencyCommand.Output execute(AddHubCurrencyCommand.Input input) throws ParticipantCommandClientException {
        ...
        try {
            ...
            LOGGER.error("Error invoking addHubCurrency : {}", e.getMessage());
