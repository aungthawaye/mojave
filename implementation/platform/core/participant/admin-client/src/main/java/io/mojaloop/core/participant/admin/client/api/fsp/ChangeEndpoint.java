...
public class ChangeEndpoint {
    ...
    public ChangeEndpointCommand.Output execute(ChangeEndpointCommand.Input input) throws ParticipantCommandClientException {

        try {

            return RetrofitService
                       .invoke(this.fspCommands.changeEndpoint(input), (status, errorResponseBody) -> RestErrorResponse.decode(errorResponseBody, this.objectMapper))
                       .body();
