...
public class ActivateEndpoint {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateEndpoint.class);

    private final ParticipantAdminService.FspCommands fspCommands;

    private final ObjectMapper objectMapper;

    public ActivateEndpoint(ParticipantAdminService.FspCommands fspCommands, ObjectMapper objectMapper) {
    ...
    public ActivateEndpointCommand.Output execute(ActivateEndpointCommand.Input input) throws ParticipantCommandClientException {
        ...
        try {
            ...
            LOGGER.error("Error invoking activateEndpoint : {}", e.getMessage());
