...
public class OracleTypeNotFoundException extends DomainException {

    private static final String TEMPLATE = "Oracle Type ({0}) cannot be not found.";

    public OracleTypeNotFoundException(PartyIdType type) {

        super(new ErrorTemplate("ORACLE_TYPE_NOT_FOUND", TEMPLATE), type.name());
