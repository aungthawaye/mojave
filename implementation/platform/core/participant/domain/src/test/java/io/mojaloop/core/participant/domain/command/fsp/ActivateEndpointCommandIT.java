...
public class ActivateEndpointCommandIT {
    ...
    public void activateEndpoint_behaviors() throws Exception {
        ...
        var out1 = activateEndpointCommand.execute(new ActivateEndpointCommand.Input(fspId, EndpointType.PARTIES));
        assertTrue(out1.activated());

        // Missing endpoint -> activated = false
        var out2 = activateEndpointCommand.execute(new ActivateEndpointCommand.Input(fspId, EndpointType.QUOTES));
    ...
    public void activateEndpoint_inactiveFsp_throws() throws Exception {
        ...
        assertThrows(CannotActivateEndpointException.class,
