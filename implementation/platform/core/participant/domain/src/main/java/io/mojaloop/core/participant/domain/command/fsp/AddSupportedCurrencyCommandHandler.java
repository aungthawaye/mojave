...
@Service
public class AddSupportedCurrencyCommandHandler implements AddSupportedCurrencyCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(AddSupportedCurrencyCommandHandler.class);

    private final FspRepository fspRepository;

    public AddSupportedCurrencyCommandHandler(FspRepository fspRepository) {
    ...
    @Transactional
    @Write
    public Output execute(Input input) throws FspIdNotFoundException, CurrencyAlreadySupportedException {
