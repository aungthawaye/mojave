...
public class ParticipantAdminApplication {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(ParticipantAdminApplication.class).web(WebApplicationType.SERVLET).properties(
            "spring.application.name=participant-admin", "spring.jmx.enabled=true", "spring.jmx.unique-types=true", "spring.jmx.default-domain=participant-admin",
            ...
            "spring.application.admin.jmx-name=org.springframework.boot:type=Admin,name=ParticipantAdminApplication,context=participant-admin").run(args);
    }
