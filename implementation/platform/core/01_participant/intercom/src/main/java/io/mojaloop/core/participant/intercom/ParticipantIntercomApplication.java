...
public class ParticipantIntercomApplication {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(ParticipantIntercomApplication.class).web(WebApplicationType.SERVLET).properties(
            "spring.application.name=participant-intercom", "spring.jmx.enabled=true", "spring.jmx.unique-types=true", "spring.jmx.default-domain=participant-intercom",
            ...
            "spring.application.admin.jmx-name=org.springframework.boot:type=Admin,name=ParticipantIntercomApplication,context=participant-intercom").run(args);
    }
