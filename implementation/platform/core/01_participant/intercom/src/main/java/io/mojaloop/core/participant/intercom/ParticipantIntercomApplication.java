...
public class ParticipantIntercomApplication {
    ...
    public static void main(String[] args) {
        ...
        var flywaySettings = new FlywayMigration.Settings(System.getenv().getOrDefault("PCP_FLYWAY_DB_URL",
        ...
        new SpringApplicationBuilder(ParticipantIntercomApplication.class).web(WebApplicationType.SERVLET).properties("spring.application.name=participant-intercom",
