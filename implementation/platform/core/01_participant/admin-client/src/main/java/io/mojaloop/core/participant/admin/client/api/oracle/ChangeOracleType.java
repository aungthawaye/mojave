...
public class ChangeOracleType {
    ...
    public ChangeOracleTypeCommand.Output execute(ChangeOracleTypeCommand.Input input) throws ParticipantAdminClientException {

        try {

            return RetrofitService.invoke(this.oracleCommands.changeType(input), (status, errorResponseBody) -> RestErrorResponse.decode(errorResponseBody, this.objectMapper))
                                  .body();
