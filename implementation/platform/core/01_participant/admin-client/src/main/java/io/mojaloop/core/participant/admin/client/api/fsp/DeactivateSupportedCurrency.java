...
public class DeactivateSupportedCurrency {
    ...
    public DeactivateFspCurrencyCommand.Output execute(DeactivateFspCurrencyCommand.Input input) throws ParticipantAdminClientException {

        try {

            return RetrofitService.invoke(this.fspCommands.deactivateSupportedCurrency(input),
