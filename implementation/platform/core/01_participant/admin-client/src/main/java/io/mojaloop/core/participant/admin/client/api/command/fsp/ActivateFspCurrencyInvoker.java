...
@Component
public class ActivateFspCurrencyInvoker implements ActivateFspCurrencyCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateFspCurrencyInvoker.class);

    private final ParticipantAdminService.FspCommand fspCommands;

    private final ObjectMapper objectMapper;

    public ActivateFspCurrencyInvoker(final ParticipantAdminService.FspCommand fspCommands, final ObjectMapper objectMapper) {
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(this.fspCommands.activateFspCurrency(input), (status, errorResponseBody) -> RestErrorResponse.decode(errorResponseBody, this.objectMapper))
                                  .body();
