...
@Component
public class ActivateOracleInvoker implements ActivateOracleCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateOracleInvoker.class);

    private final ParticipantAdminService.OracleCommands oracleCommands;

    private final ObjectMapper objectMapper;

    public ActivateOracleInvoker(final ParticipantAdminService.OracleCommands oracleCommands, final ObjectMapper objectMapper) {
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(this.oracleCommands.activateOracle(input), (status, errorResponseBody) -> RestErrorResponse.decode(errorResponseBody, this.objectMapper))
                                  .body();
