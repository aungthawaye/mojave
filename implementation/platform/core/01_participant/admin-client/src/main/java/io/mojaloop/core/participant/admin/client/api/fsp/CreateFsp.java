...
public class CreateFsp {
    ...
    public CreateFspCommand.Output execute(CreateFspCommand.Input input) throws ParticipantAdminClientException {

        try {

            return RetrofitService.invoke(this.fspCommands.createFsp(input), (status, errorResponseBody) -> RestErrorResponse.decode(errorResponseBody, this.objectMapper)).body();
