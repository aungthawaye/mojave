...
public class ActivateHubCurrencyIT {
    ...
    @Test
    public void test_successfully_activate_currency() throws ParticipantAdminClientException {
        ...
        this.activateHubCurrency.execute(new ActivateHubCurrencyCommand.Input(new HubId(), Currency.EUR));
    }
