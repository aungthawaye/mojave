...
public class ActivateSupportedCurrencyIT {
    ...
    public void test_successfully_activate_supported_currency() throws ParticipantAdminClientException {
        ...
        var output = this.createFsp.execute(new CreateFspCommand.Input(new FspCode("fsp-activate-currency"),
                                                                       "FSP Activate Currency",
