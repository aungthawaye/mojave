...
public class ChangeChartEntryProperties {
    ...
    public ChangeChartEntryProperties(AccountAdminService.ChartCommands chartCommands, ObjectMapper objectMapper) {
    ...
    public void execute(ChangeChartEntryPropertiesCommand.Input input) throws AccountAdminClientException {

        try {

            RetrofitService
                .invoke(this.chartCommands.changeChartEntryProperties(input),
