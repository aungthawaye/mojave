...
import io.mojaloop.core.quoting.domain.TestConfiguration;
...
public abstract class BaseDomainIT {
    ...
    void cleanupDb() {
        ...
        this.jdbcTemplate.execute("TRUNCATE TABLE qot_quote_extension");
        this.jdbcTemplate.execute("TRUNCATE TABLE qot_quote");
