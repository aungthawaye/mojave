...
public class QuotingServiceApplication {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(QuotingServiceApplication.class).web(WebApplicationType.SERVLET).properties(
            "spring.application.name=quoting-service", "spring.jmx.enabled=true", "spring.jmx.unique-types=true", "spring.jmx.default-domain=quoting-service",
            ...
            "spring.application.admin.jmx-name=org.springframework.boot:type=Admin,name=QuotingServiceApplication,context=quoting-service").run(args);
    }
