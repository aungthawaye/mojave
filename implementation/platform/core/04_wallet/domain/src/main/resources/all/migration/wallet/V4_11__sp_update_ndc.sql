...
CREATE PROCEDURE sp_update_ndc(
...
BEGIN
    /* -------- Variables -------- */
    DECLARE
        v_position DECIMAL(34, 4);
    DECLARE
        v_reserved DECIMAL(34, 4);
    DECLARE
        v_current_total DECIMAL(34, 4);
    ...
    SET
        v_current_total = v_position + v_reserved;

    IF
        v_current_total > p_new_ndc THEN
        ROLLBACK;
