...
public class CommitPositionCommandIT extends BaseDomainIT {
    ...
    @Autowired
    private CommitPositionCommand commitPositionCommand;
    ...
    void should_commit_reserved_successfully() {
        ...
        final var input = new CommitPositionCommand.Input(reservationId, commitUpdateId, "Commit reservation");
    ...
    void should_fail_commit_when_not_a_reservation() {
        ...
        final var input = new CommitPositionCommand.Input(reservationId, commitUpdateId, "Commit invalid");
