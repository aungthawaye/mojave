...
public class IncreasePositionCommandIT extends BaseDomainIT {
    ...
    void should_fail_when_increase_exceeds_net_debit_cap() {
        ...
        final var createOut = this.createPositionCommand.execute(
            new CreatePositionCommand.Input(new WalletOwnerId(85002L), Currency.USD, "Cap Position", new BigDecimal("50.0000")));
    ...
    void should_increase_position_successfully() throws
        ...
        // Arrange
        final var createOut = this.createPositionCommand.execute(
            new CreatePositionCommand.Input(new WalletOwnerId(85001L), Currency.USD, "Position I", new BigDecimal("100.0000")));
        final var positionId = createOut.positionId();
