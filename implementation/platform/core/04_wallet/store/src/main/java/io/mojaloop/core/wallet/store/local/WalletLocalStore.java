...
import io.mojaloop.core.wallet.intercom.client.api.GetWallets;
...
@Component
public class WalletLocalStore implements WalletStore {

    private static final Logger LOGGER = LoggerFactory.getLogger(WalletLocalStore.class);
    ...
    public WalletLocalStore(final GetWallets getWallets, final WalletStoreConfiguration.Settings walletStoreSettings) {

        assert getWallets != null;
    ...
    public void bootstrap() {
        ...
        LOGGER.info("Bootstrapping WalletLocalStore");
        this.refreshData();
        ...
        this.timer.scheduleAtFixedRate(
            new TimerTask() {
                ...
                public void run() {
                    ...
                    WalletLocalStore.this.refreshData();
                }
            }, interval, interval);
    }
    ...
    private void refreshData() {
        ...
        try {
            ...
            List<WalletData> wallets = this.getWallets.execute();
