...
@Component
public class IncreasePosition {

    private static final Logger LOGGER = LoggerFactory.getLogger(IncreasePosition.class);

    private final WalletIntercomService walletIntercomService;

    private final ObjectMapper objectMapper;

    public IncreasePosition(final WalletIntercomService walletIntercomService, final ObjectMapper objectMapper) {
    ...
    public IncreasePositionCommand.Output execute(final IncreasePositionCommand.Input input) throws WalletIntercomClientException {
