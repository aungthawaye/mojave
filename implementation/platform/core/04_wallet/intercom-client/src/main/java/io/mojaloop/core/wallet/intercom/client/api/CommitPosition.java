...
public class CommitPosition {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CommitPosition.class);

    private final WalletIntercomService walletIntercomService;

    private final ObjectMapper objectMapper;

    public CommitPosition(final WalletIntercomService walletIntercomService, final ObjectMapper objectMapper) {
    ...
    public CommitPositionCommand.Output execute(final CommitPositionCommand.Input input) throws WalletIntercomClientException {
        ...
        try {
            ...
            LOGGER.error("Error invoking commitPosition : {}", e.getMessage());
