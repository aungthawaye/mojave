...
@Component
public class ReverseFund {

    private static final Logger LOGGER = LoggerFactory.getLogger(ReverseFund.class);

    private final WalletIntercomService walletIntercomService;

    private final ObjectMapper objectMapper;

    public ReverseFund(final WalletIntercomService walletIntercomService, final ObjectMapper objectMapper) {
    ...
    public ReverseFundCommand.Output execute(final ReverseFundCommand.Input input) throws WalletIntercomClientException {
        ...
        try {
            ...
            LOGGER.error("Error invoking reverseFund : {}", e.getMessage());
