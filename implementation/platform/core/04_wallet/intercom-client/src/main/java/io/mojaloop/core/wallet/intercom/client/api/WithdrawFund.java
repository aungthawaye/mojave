...
public class WithdrawFund {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(WithdrawFund.class);

    private final WalletIntercomService walletIntercomService;

    private final ObjectMapper objectMapper;

    public WithdrawFund(final WalletIntercomService walletIntercomService, final ObjectMapper objectMapper) {
    ...
    public WithdrawFundCommand.Output execute(final WithdrawFundCommand.Input input) throws WalletIntercomClientException {
        ...
        try {
            ...
            LOGGER.error("Error invoking withdrawFund : {}", e.getMessage());
