...
package io.mojaloop.core.wallet.intercom.client.api.command.balance;
...
public class ReverseFundInvoker implements ReverseFundCommand {
    ...
    public ReverseFundInvoker(final WalletIntercomService.BalanceCommand balanceCommand,
    ...
    public Output execute(final Input input) throws ReversalFailedInWalletException {
        ...
        try {
            ...
            return RetrofitService
                       .invoke(
                           this.balanceCommand.reverseFund(input),
