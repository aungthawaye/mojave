...
public class WalletQueryInvoker implements WalletQuery {
    ...
    private final WalletIntercomService.WalletQuery walletQuery;

    private final ObjectMapper objectMapper;

    public WalletQueryInvoker(final WalletIntercomService.WalletQuery walletQuery, final ObjectMapper objectMapper) {
