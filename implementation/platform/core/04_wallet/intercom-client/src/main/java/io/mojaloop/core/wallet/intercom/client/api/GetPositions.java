...
public class GetPositions {
    ...
    public List<PositionData> execute() throws WalletIntercomClientException {
        ...
        try {
            ...
            return RetrofitService.invoke(this.walletIntercomService.getPositions(), (status, errorResponseBody) -> RestErrorResponse.decode(errorResponseBody, this.objectMapper))
                                  .body();
