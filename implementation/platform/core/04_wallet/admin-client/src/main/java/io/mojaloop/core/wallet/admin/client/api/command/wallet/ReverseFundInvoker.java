...
package io.mojaloop.core.wallet.admin.client.api.command.wallet;
...
@Component
public class ReverseFundInvoker implements ReverseFundCommand {

    private final WalletAdminService.WalletCommand walletCommand;

    private final ObjectMapper objectMapper;

    public ReverseFundInvoker(final WalletAdminService.WalletCommand walletCommand, final ObjectMapper objectMapper) {
    ...
    public Output execute(final Input input) throws ReversalFailedInWalletException {
        ...
        try {
            ...
            return RetrofitService.invoke(this.walletCommand.reverseFund(input), (status, errorResponseBody) -> RestErrorResponse.decode(errorResponseBody, this.objectMapper))
                                  .body();
