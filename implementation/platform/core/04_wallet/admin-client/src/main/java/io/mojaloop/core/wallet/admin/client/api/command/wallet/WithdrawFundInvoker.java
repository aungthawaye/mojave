...
public class WithdrawFundInvoker implements WithdrawFundCommand {
    ...
    public WithdrawFundInvoker(final WalletAdminService.WalletCommand walletCommand, final ObjectMapper objectMapper) {
    ...
    public Output execute(final Input input)
        ...
        try {
            ...
            return RetrofitService.invoke(this.walletCommand.withdrawFund(input),
