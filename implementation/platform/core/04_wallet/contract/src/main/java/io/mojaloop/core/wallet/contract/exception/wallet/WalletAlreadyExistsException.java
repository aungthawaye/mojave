...
public class WalletAlreadyExistsException extends UncheckedDomainException {
    ...
    public WalletAlreadyExistsException(final WalletOwnerId ownerId, final Currency currency) {
    ...
    public static WalletAlreadyExistsException from(final Map<String, String> extras) {
        ...
        return new WalletAlreadyExistsException(ownerId, currency);
    }
