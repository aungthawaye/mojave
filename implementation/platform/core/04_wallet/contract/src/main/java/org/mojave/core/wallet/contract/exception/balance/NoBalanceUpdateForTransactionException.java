...
public class NoBalanceUpdateForTransactionException extends CheckedDomainException {
    ...
    public static final String CODE = "NO_BALANCE_UPDATE_FOR_TRANSACTION";

    private static final String TEMPLATE = "No balance update for transaction : transaction id: ({0}).";

    private final TransactionId transactionId;

    public NoBalanceUpdateForTransactionException(final TransactionId transactionId) {
    ...
    public static NoBalanceUpdateForTransactionException from(final Map<String, String> extras) {

        final var transactionId = new TransactionId(Long.valueOf(extras.get(Keys.TRANSACTION_ID)));

        return new NoBalanceUpdateForTransactionException(transactionId);
    }
