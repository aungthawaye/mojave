...
@Getter
public class BalanceAlreadyExistsException extends UncheckedDomainException {

    public static final String CODE = "WALLET_ALREADY_EXISTS";

    private static final String TEMPLATE = "Wallet already exists for Owner Id ({0}) and Currency ({1}).";

    private final WalletOwnerId ownerId;

    private final Currency currency;

    public BalanceAlreadyExistsException(final WalletOwnerId ownerId, final Currency currency) {
    ...
    public static BalanceAlreadyExistsException from(final Map<String, String> extras) {
        ...
        return new BalanceAlreadyExistsException(ownerId, currency);
    }
