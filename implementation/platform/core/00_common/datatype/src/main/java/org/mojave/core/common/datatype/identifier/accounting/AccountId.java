...
public class AccountId extends EntityId<Long> {
    ...
    public static class Deserializer extends ValueDeserializer<AccountId> {

        @Override
        public AccountId deserialize(JsonParser p, DeserializationContext ctx) throws JacksonException {
    ...
    @Component
    public static class ParamConverter implements Converter<String, AccountId> {

        @Override
        public AccountId convert(String source) {

            return new AccountId(Long.parseLong(source));
        }
