...
public class QuoteId extends EntityId<Long> {
    ...
    public static class Deserializer extends JsonDeserializer<QuoteId> {

        @Override
        public QuoteId deserialize(JsonParser p, DeserializationContext ctx) throws IOException {
