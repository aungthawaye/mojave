...
public class NetDebitCapUpdateId extends EntityId<Long> {
    ...
    public static class Deserializer extends JsonDeserializer<NetDebitCapUpdateId> {

        @Override
        public NetDebitCapUpdateId deserialize(JsonParser p, DeserializationContext ctx) throws IOException {
