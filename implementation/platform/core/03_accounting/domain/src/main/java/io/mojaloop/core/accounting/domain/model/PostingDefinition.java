...
@Table(name = "acc_posting_definition",
       uniqueConstraints = {@UniqueConstraint(name = "acc_posting_definition_for_posting_UK", columnNames = {"for_owner, for_amount, chart_entry_id"})})
...
public class PostingDefinition extends JpaEntity<PostingDefinitionId> {
    ...
    @JoinColumn(name = "definition_id", nullable = false, foreignKey = @ForeignKey(name = "fund_in_posting_fund_in_definition_FK"))
