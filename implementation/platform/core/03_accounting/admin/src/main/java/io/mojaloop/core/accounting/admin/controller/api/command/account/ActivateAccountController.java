...
public class ActivateAccountController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateAccountController.class);

    private final ActivateAccountCommand activateAccountCommand;

    public ActivateAccountController(ActivateAccountCommand activateAccountCommand) {

        assert activateAccountCommand != null;
    ...
    @ResponseBody
    public ActivateAccountCommand.Output execute(
        @Valid @RequestBody ActivateAccountCommand.Input input) {
