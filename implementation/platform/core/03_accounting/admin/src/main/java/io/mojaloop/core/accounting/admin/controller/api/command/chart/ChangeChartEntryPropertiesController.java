...
public class ChangeChartEntryPropertiesController {
    ...
    public ChangeChartEntryPropertiesController(ChangeChartEntryPropertiesCommand changeChartEntryPropertiesCommand) {

        assert changeChartEntryPropertiesCommand != null;

        this.changeChartEntryPropertiesCommand = changeChartEntryPropertiesCommand;
    }

    @PostMapping("/chart-entries/change-properties")
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public ChangeChartEntryPropertiesCommand.Output execute(
        @Valid @RequestBody ChangeChartEntryPropertiesCommand.Input input) {
