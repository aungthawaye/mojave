...
public class TerminateAccountController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(TerminateAccountController.class);

    private final TerminateAccountCommand terminateAccountCommand;

    public TerminateAccountController(TerminateAccountCommand terminateAccountCommand) {

        assert terminateAccountCommand != null;
    ...
    @ResponseBody
    public TerminateAccountCommand.Output execute(
        @Valid @RequestBody TerminateAccountCommand.Input input) {
