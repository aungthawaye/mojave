...
public class DeactivateAccountController {
    ...
    public DeactivateAccountController(DeactivateAccountCommand deactivateAccountCommand) {

        assert deactivateAccountCommand != null;
    ...
    @ResponseBody
    public DeactivateAccountCommand.Output execute(
        @Valid @RequestBody DeactivateAccountCommand.Input input) {
