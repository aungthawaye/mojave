...
- Inside `AccountingAdminService.AccountCommand`, create the methods according
  to the controllers inside
...
- Inside `AccountingAdminService.DefinitionQuery`, create the methods according
  to the methods inside `FlowDefinitionQueryController`.
- Inside `AccountingAdminService.LedgerCommand`, create the methods according to
  the controllers inside
  `org.mojave.core.accounting.admin.controller.api.command.ledger`

## Creating the Invoker classes

- Create Invoker classes in
  `org.mojave.core.accounting.admin.client.api.command`. Refer to
  PostTransactionInvoker.java.
