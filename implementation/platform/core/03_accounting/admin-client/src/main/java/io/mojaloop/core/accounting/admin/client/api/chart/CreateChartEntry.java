...
public class CreateChartEntry {
    ...
    public CreateChartEntry(AccountAdminService.ChartCommands chartCommands, ObjectMapper objectMapper) {
    ...
    public CreateChartEntryCommand.Output execute(CreateChartEntryCommand.Input input) throws AccountAdminClientException {

        try {

            return RetrofitService
                       .invoke(this.chartCommands.createChartEntry(input),
