...
public class TerminateAccount {
    ...
    public TerminateAccount(AccountAdminService.AccountCommands accountCommands, ObjectMapper objectMapper) {
    ...
    public void execute(TerminateAccountCommand.Input input) throws AccountAdminClientException {
