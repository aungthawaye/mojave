...
class ActivateEndpointCommandIT extends BaseDomainIT {
    ...
    @Autowired
    private ActivateEndpointCommand activateEndpoint;

    @Test
    void should_activate_existing_endpoint() throws Exception {
        ...
        // Act
        var output = this.activateEndpoint.execute(input);
    ...
    @Test
    void should_throw_when_endpoint_not_configured() throws Exception {
        ...
        // Act & Assert
        Assertions.assertThrows(CannotActivateFspEndpointException.class, () -> this.activateEndpoint.execute(input));
    }
    ...
    void should_throw_when_fsp_not_found() {
        ...
        // Arrange
        var input = new ActivateEndpointCommand.Input(new FspId(333_333L), EndpointType.PARTIES);
