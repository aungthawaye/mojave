...
package io.mojaloop.core.participant.admin.controller.api.command.oracle;
...
public class ActivateOracleController {
    ...
    @ResponseBody
    public ActivateOracleCommand.Output execute(
        @Valid @RequestBody ActivateOracleCommand.Input input) {
