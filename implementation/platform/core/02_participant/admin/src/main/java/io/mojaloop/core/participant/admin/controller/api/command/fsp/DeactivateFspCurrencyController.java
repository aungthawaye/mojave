...
package io.mojaloop.core.participant.admin.controller.api.command.fsp;
...
@RestController
public class DeactivateFspCurrencyController implements DeactivateFspCurrencyCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(
        DeactivateFspCurrencyController.class);
    ...
    public DeactivateFspCurrencyCommand.Output execute(
        @Valid @RequestBody DeactivateFspCurrencyCommand.Input input) {
