 ...
 * ================================================================================
 */
package io.mojaloop.common.component.persistence.routing.annotation.aspect;
...
public class WriteAspect {
    ...
    @Around(
        "execution(public * *(..)) && @annotation(io.mojaloop.common.component.persistence.routing.annotation.Write)")
