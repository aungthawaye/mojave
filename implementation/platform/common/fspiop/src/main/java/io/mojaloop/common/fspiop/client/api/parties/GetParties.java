...
public interface GetParties {
    ...
    void getParties(Destination destination, PartyIdType partyIdType, String partyId, String subId);

    void getParties(Destination destination, PartyIdType partyIdType, String partyId);
