...
class PatchTransfersHandler implements PatchTransfers {
    ...
    public PatchTransfersHandler(ParticipantDetails participantDetails,
    ...
    public void patchTransfers(Destination destination, String transferId, TransfersIDPatchResponse transfersIDPatchResponse) {
        ...
        try {
            ...
            var fspiopHeaders = FspiopHeaders.Values.Transfers.forCallback(this.participantDetails.fspCode().getFspCode(),
