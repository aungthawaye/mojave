...
class PostTransfersHandler implements PostTransfers {
    ...
    public PostTransfersHandler(ParticipantDetails participantDetails,
    ...
    public void postTransfers(Destination destination, TransfersPostRequest transfersPostRequest) {
        ...
        try {
            ...
            var fspiopHeaders = FspiopHeaders.Values.Transfers.forRequest(this.participantDetails.fspCode().getFspCode(),
