...
import io.mojaloop.common.component.crypto.Rs256;
...
public record ParticipantDetails(FspCode fspCode,
                                 String fspName,
                                 String ilpSecret,
                                 boolean signJws,
                                 boolean verifyJws,
    ...
    public static ParticipantDetails with(String fspCode,
        ...
        return new ParticipantDetails(new FspCode(fspCode), fspName, ilpSecret, signJws, verifyJws, signingKey, publicKeys);
    }
