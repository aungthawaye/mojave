...
@Component
public class ChangeAccountPropertiesCommandRequestor implements ChangeAccountPropertiesCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeAccountPropertiesCommandRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public ChangeAccountPropertiesCommandRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ChangeAccountPropertiesCommandRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("ChangeAccountPropertiesCommandRequestor : output : ({})", ObjectLogger.log(output));
