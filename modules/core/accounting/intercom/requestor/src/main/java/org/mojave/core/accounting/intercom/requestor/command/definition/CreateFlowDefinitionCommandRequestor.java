...
@Component
public class CreateFlowDefinitionCommandRequestor implements CreateFlowDefinitionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateFlowDefinitionCommandRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public CreateFlowDefinitionCommandRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("CreateFlowDefinitionCommandRequestor : input: ({})", ObjectLogger.log(input));

        try {

            final var output = CommandRequestor.request(
                this.connection, CreateFlowDefinitionCommand.SUBJECT_NAME,
                input, Output.class, this.objectMapper);

            LOGGER.info("CreateFlowDefinitionCommandRequestor : output : ({})", ObjectLogger.log(output));
