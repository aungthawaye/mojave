...
@Component
public class ChangeFlowDefinitionPropertiesCommandRequestor implements ChangeFlowDefinitionPropertiesCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeFlowDefinitionPropertiesCommandRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public ChangeFlowDefinitionPropertiesCommandRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ChangeFlowDefinitionPropertiesCommandRequestor : input: ({})", ObjectLogger.log(input));

        try {

            final var output = CommandRequestor.request(
                this.connection, ChangeFlowDefinitionPropertiesCommand.SUBJECT_NAME,
                input, Output.class, this.objectMapper);

            LOGGER.info("ChangeFlowDefinitionPropertiesCommandRequestor : output : ({})", ObjectLogger.log(output));
