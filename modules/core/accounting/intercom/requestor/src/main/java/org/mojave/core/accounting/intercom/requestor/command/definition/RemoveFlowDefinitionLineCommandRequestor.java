...
@Component
public class RemoveFlowDefinitionLineCommandRequestor implements RemoveFlowDefinitionLineCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(RemoveFlowDefinitionLineCommandRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public RemoveFlowDefinitionLineCommandRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("RemoveFlowDefinitionLineCommandRequestor : input: ({})", ObjectLogger.log(input));

        try {

            final var output = NatsRequestor.request(
                this.connection, RemoveFlowDefinitionLineCommand.SUBJECT_NAME,
                input, Output.class, this.objectMapper);

            LOGGER.info("RemoveFlowDefinitionLineCommandRequestor : output : ({})", ObjectLogger.log(output));
