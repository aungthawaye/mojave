...
@Component
public class ChangeFlowDefinitionCurrencyCommandRequestor implements ChangeFlowDefinitionCurrencyCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeFlowDefinitionCurrencyCommandRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public ChangeFlowDefinitionCurrencyCommandRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ChangeFlowDefinitionCurrencyCommandRequestor : input: ({})", ObjectLogger.log(input));

        try {

            final var output = CommandRequestor.request(
                this.connection, ChangeFlowDefinitionCurrencyCommand.SUBJECT_NAME,
                input, Output.class, this.objectMapper);

            LOGGER.info("ChangeFlowDefinitionCurrencyCommandRequestor : output : ({})", ObjectLogger.log(output));
