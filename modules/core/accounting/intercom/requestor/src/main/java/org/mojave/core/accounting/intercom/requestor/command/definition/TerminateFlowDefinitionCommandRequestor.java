...
@Component
public class TerminateFlowDefinitionCommandRequestor implements TerminateFlowDefinitionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(TerminateFlowDefinitionCommandRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public TerminateFlowDefinitionCommandRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("TerminateFlowDefinitionCommandRequestor : input: ({})", ObjectLogger.log(input));

        try {

            final var output = NatsRequestor.request(
                this.connection, TerminateFlowDefinitionCommand.SUBJECT_NAME,
                input, Output.class, this.objectMapper);

            LOGGER.info("TerminateFlowDefinitionCommandRequestor : output : ({})", ObjectLogger.log(output));
