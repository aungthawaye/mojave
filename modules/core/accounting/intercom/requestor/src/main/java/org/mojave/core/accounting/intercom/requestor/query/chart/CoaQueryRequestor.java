...
@Component
public class CoaQueryRequestor implements CoaQuery {

    private static final Logger LOGGER = LoggerFactory.getLogger(CoaQueryRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public CoaQueryRequestor(final Connection connection,
    ...
    @Override
    public CoaData get(final CoaId coaId) {

        final var input = new GetByIdInput(coaId);

        LOGGER.info("CoaQueryRequestor.get(CoaId) : input: ({})", ObjectLogger.log(input));

        try {

            final var output = NatsRequestor.request(
                this.connection, GET_BY_ID_SUBJECT_NAME, input, CoaData.class, this.objectMapper);

            LOGGER.info("CoaQueryRequestor.get(CoaId) : output : ({})", ObjectLogger.log(output));
    ...
    public List<CoaData> getAll() {
        ...
        LOGGER.info("CoaQueryRequestor.getAll : input: ({})", ObjectLogger.log(new GetAllInput()));

        try {

            final var output = NatsRequestor.requestList(
                this.connection, GET_ALL_SUBJECT_NAME, new GetAllInput(),
                CoaData.class, this.objectMapper);

            LOGGER.info("CoaQueryRequestor.getAll : output : ({})", ObjectLogger.log(output));
    ...
    public List<CoaData> getByNameContains(final String name) {
        ...
        LOGGER.info("CoaQueryRequestor.getByNameContains : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("CoaQueryRequestor.getByNameContains : output : ({})",
