...
@Component
public class ActivateFlowDefinitionCommandRequestor implements ActivateFlowDefinitionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateFlowDefinitionCommandRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public ActivateFlowDefinitionCommandRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ActivateFlowDefinitionCommandRequestor : input: ({})", ObjectLogger.log(input));

        try {

            final var output = CommandRequestor.request(
                this.connection, ActivateFlowDefinitionCommand.SUBJECT_NAME,
                input, Output.class, this.objectMapper);

            LOGGER.info("ActivateFlowDefinitionCommandRequestor : output : ({})", ObjectLogger.log(output));
