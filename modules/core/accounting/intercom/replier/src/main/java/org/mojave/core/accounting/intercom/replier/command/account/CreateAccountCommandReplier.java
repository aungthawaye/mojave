...
@Component
public class CreateAccountCommandReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateAccountCommandReplier.class);
    ...
    public CreateAccountCommandReplier(final CreateAccountCommand createAccountCommand,
        ...
        this.connection.createDispatcher(this::handle).subscribe(CreateAccountCommand.SUBJECT_NAME);
    }
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("CreateAccountCommandReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            final var input = this.objectMapper.readValue(
                message.getData(), CreateAccountCommand.Input.class);

            LOGGER.info("CreateAccountCommandReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("CreateAccountCommandReplier : output : ({})", ObjectLogger.log(output));
