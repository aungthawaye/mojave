...
@Component
public class DeactivateFlowDefinitionCommandReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeactivateFlowDefinitionCommandReplier.class);
    ...
    public DeactivateFlowDefinitionCommandReplier(final DeactivateFlowDefinitionCommand deactivateFlowDefinitionCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("DeactivateFlowDefinitionCommandReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("DeactivateFlowDefinitionCommandReplier : output : ({})", ObjectLogger.log(output));
