...
@Component
public class DeactivateAccountCommandReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeactivateAccountCommandReplier.class);
    ...
    public DeactivateAccountCommandReplier(final DeactivateAccountCommand deactivateAccountCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("DeactivateAccountCommandReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("DeactivateAccountCommandReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("DeactivateAccountCommandReplier : output : ({})", ObjectLogger.log(output));
