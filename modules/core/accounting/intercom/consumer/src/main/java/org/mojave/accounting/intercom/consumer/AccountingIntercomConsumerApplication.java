...
@Import(
    value = {
        ...
        AccountingIntercomConsumerDependencies.class,
        AccountingIntercomConsumerSettings.class})
public class AccountingIntercomConsumerApplication {

    private static final Logger LOGGER = LoggerFactory.getLogger(
        AccountingIntercomConsumerApplication.class);
