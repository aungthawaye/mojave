...
@Component
public class CreateCoaInvoker implements CreateCoaCommand {

    private final AccountingAdminService.CoaCommand coaCommand;

    private final ObjectMapper objectMapper;

    public CreateCoaInvoker(final AccountingAdminService.CoaCommand coaCommand,
