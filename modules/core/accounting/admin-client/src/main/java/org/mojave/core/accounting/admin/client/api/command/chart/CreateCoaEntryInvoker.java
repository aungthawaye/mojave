...
@Component
public class CreateCoaEntryInvoker implements CreateCoaEntryCommand {

    private final AccountingAdminService.CoaCommand coaCommand;

    private final ObjectMapper objectMapper;

    public CreateCoaEntryInvoker(final AccountingAdminService.CoaCommand coaCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.coaCommand.createEntry(input),
