...
package org.mojave.core.accounting.admin.client.api.command.account;
...
public class ChangeAccountPropertiesInvoker implements ChangeAccountPropertiesCommand {
    ...
    public ChangeAccountPropertiesInvoker(final AccountingAdminService.AccountCommand accountCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.accountCommand.changeProperties(input),
