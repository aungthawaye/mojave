...
@Component
public class ChangeCoaEntryPropertiesInvoker implements ChangeCoaEntryPropertiesCommand {

    private final AccountingAdminService.CoaCommand coaCommand;

    private final ObjectMapper objectMapper;

    public ChangeCoaEntryPropertiesInvoker(final AccountingAdminService.CoaCommand coaCommand,
                                           final ObjectMapper objectMapper) {

        Objects.requireNonNull(coaCommand);
        Objects.requireNonNull(objectMapper);

        this.coaCommand = coaCommand;
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.coaCommand.changeEntryProperties(input),
