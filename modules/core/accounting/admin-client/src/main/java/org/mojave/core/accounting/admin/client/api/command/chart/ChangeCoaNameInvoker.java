...
@Component
public class ChangeCoaNameInvoker implements ChangeCoaNameCommand {

    private final AccountingAdminService.CoaCommand coaCommand;

    private final ObjectMapper objectMapper;

    public ChangeCoaNameInvoker(final AccountingAdminService.CoaCommand coaCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.coaCommand.changeName(input),
