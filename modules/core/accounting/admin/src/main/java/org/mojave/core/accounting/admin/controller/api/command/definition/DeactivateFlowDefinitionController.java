...
public class DeactivateFlowDefinitionController {
    ...
    @PostMapping("/accounting/flow-definitions/deactivate-flow-definition")
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public DeactivateFlowDefinitionCommand.Output execute(
        @Valid @RequestBody final DeactivateFlowDefinitionCommand.Input input) {
