...
@Getter
public class RequireParticipantForCoaEntryException extends UncheckedDomainException {
    ...
    public static RequireParticipantForCoaEntryException from(final Map<String, String> extras) {

        return new RequireParticipantForCoaEntryException();
    }
