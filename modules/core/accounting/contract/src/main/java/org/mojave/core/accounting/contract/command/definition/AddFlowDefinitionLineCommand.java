...
public interface AddFlowDefinitionLineCommand {

    String SUBJECT_NAME = "sub-accounting.add-flow-definition-line-command";

    String TOPIC_NAME = "tp-accounting.add-flow-definition-line-command";

    Output execute(Input input);

    record Input(@JsonProperty(required = true) @NotNull FlowDefinitionId flowDefinitionId,
                 @JsonProperty(required = true) @NotNull FlowDefinitionLine flowDefinitionLine) {
    ...
    record Output(FlowDefinitionId flowDefinitionId, FlowDefinitionLineId flowDefinitionLineId) { }
