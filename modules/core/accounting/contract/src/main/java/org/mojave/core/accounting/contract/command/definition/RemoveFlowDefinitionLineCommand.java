...
public interface RemoveFlowDefinitionLineCommand {

    String SUBJECT_NAME = "sub-accounting.remove-flow-definition-line-command";

    String TOPIC_NAME = "tp-accounting.remove-flow-definition-line-command";

    Output execute(Input input);

    record Input(@JsonProperty(required = true) @NotNull FlowDefinitionId flowDefinitionId,
                 @JsonProperty(required = true) @NotNull FlowDefinitionLineId flowDefinitionLineId) {
