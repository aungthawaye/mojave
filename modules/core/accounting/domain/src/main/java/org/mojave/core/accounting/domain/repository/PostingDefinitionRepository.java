...
import org.mojave.core.accounting.domain.model.PostingDefinition;
...
public interface PostingDefinitionRepository
    extends JpaRepository<PostingDefinition, PostingDefinitionId>,
            JpaSpecificationExecutor<PostingDefinition> {
