...
public interface CoaEntryCache {

    void clear();

    void delete(CoaEntryId coaEntryId);

    CoaEntryData get(CoaEntryId coaEntryId);

    CoaEntryData get(CoaEntryCode code);

    Set<CoaEntryData> get(CoaId coaId);

    void save(CoaEntryData coaEntry);
    ...
    class Names {
        ...
        public static final String WITH_ID = "acc-coa-entry-with-id";

        public static final String WITH_CODE = "acc-coa-entry-with-code";
