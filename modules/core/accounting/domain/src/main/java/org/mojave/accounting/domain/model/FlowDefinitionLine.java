...
import org.mojave.accounting.contract.exception.definition.DuplicateFlowDefinitionLineIndexException;
...
import org.mojave.scheme.rule.accounting.SchemeSenarioDefinitions;
...
public class FlowDefinitionLine extends JpaEntity<FlowDefinitionLineId> {
    ...
    public FlowDefinitionLine forFlowDefinitionLine(Integer step, String participant, CoaEntryId coaEntryId,
        ...
        var scenarioDefinition = SchemeSenarioDefinitions.get(this.definition.scenario);
