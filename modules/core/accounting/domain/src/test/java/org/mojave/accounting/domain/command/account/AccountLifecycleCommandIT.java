...
import org.mojave.accounting.contract.command.account.ChangeAccountPropertiesCommand;
import org.mojave.accounting.contract.command.account.CreateAccountByCategoryCommand;
...
import org.mojave.accounting.contract.command.account.TerminateAccountCommand;
...
import org.mojave.accounting.contract.exception.account.AccountIdNotFoundException;
import org.mojave.accounting.contract.query.AccountQuery;
...
public class AccountLifecycleCommandIT extends BaseIT {
    ...
    public void changeAccountPropertiesAccountIdNotFound() {
        ...
        assertThrows(
            AccountIdNotFoundException.class, () -> this.changeAccountPropertiesCommand.execute(
                new ChangeAccountPropertiesCommand.Input(
                    new AccountId(Long.MAX_VALUE), "Missing",
                    "Missing")));
    }
    ...
    public void changeAccountPropertiesSuccessful() {
        ...
        final var coaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, "FSP", "CHANGE_ACC_ENTRY_01",
            "Change Account Entry 01", AccountType.ASSET);
        final var accountId = this.createAccount(
            this.createAccountCommand, coaEntryId, 601L, Currency.USD, "CHANGE_ACC_01",
            "Change Account 01");

        final var output = this.changeAccountPropertiesCommand.execute(
            new ChangeAccountPropertiesCommand.Input(
                accountId, "Changed Account Name",
    ...
    public void changeAccountPropertiesWithNullValues() {
        ...
        final var coaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, "FSP", "CHANGE_ACC_ENTRY_02",
            "Change Account Entry 02", AccountType.ASSET);
        final var accountId = this.createAccount(
            this.createAccountCommand, coaEntryId, 602L, Currency.USD, "CHANGE_ACC_02",
            "Change Account 02");
    ...
    public void createAccountByCategorySuccessful() {
        ...
        this.createCoaEntry(
            this.createCoaEntryCommand, coaId, "FSP", "CREATE_BY_CATEGORY_01",
            "Create By Category 01", AccountType.ASSET);
        this.createCoaEntry(
            this.createCoaEntryCommand, coaId, "FSP", "CREATE_BY_CATEGORY_02",
            "Create By Category 02", AccountType.LIABILITY);
        this.createCoaEntry(
            this.createCoaEntryCommand, coaId, "HUB", "CREATE_BY_CATEGORY_03",
            "Create By Category 03", AccountType.REVENUE);

        final var output = this.createAccountByCategoryCommand.execute(
            new CreateAccountByCategoryCommand.Input(
                new AccountOwnerId(603L), new FspCode("FSP01"),
                Currency.USD, "FSP"));
        final var accounts = output
                                 .accountIds()
                                 .stream()
        ...
        assertEquals("FSP01-CREATE_BY_CATEGORY_01-USD", accounts.getFirst().code().value());
        assertEquals("FSP01-CREATE_BY_CATEGORY_02-USD", accounts.get(1).code().value());
    }
    ...
    public void createAccountByCategoryWithoutMatches() {
        ...
        this.createCoaEntry(
            this.createCoaEntryCommand, coaId, "HUB", "CREATE_BY_CATEGORY_EMPTY_01",
            "Create By Category Empty 01", AccountType.ASSET);

        final var output = this.createAccountByCategoryCommand.execute(
            new CreateAccountByCategoryCommand.Input(
                new AccountOwnerId(604L), new FspCode("FSP02"),
                Currency.USD, "FSP"));
    ...
    public void deactivateAccountNotFound() {
        ...
        assertThrows(
            AccountIdNotFoundException.class, () -> this.deactivateAccountCommand.execute(
    ...
    public void deactivateAccountSuccessful() {
        ...
        final var coaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, "FSP", "DEACTIVATE_ACC_ENTRY_01",
            "Deactivate Account Entry 01", AccountType.ASSET);
        final var accountId = this.createAccount(
            this.createAccountCommand, coaEntryId, 605L, Currency.USD, "DEACTIVATE_ACC_01",
    ...
    public void terminateAccountNotFound() {
        ...
        assertThrows(
            AccountIdNotFoundException.class, () -> this.terminateAccountCommand.execute(
    ...
    public void terminateAccountSuccessful() {
        ...
        final var coaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, "FSP", "TERMINATE_ACC_ENTRY_01",
            "Terminate Account Entry 01", AccountType.ASSET);
        final var accountId = this.createAccount(
            this.createAccountCommand, coaEntryId, 606L, Currency.USD, "TERMINATE_ACC_01",
