...
public class CreateFlowDefinitionCommandIT extends BaseIT {
    ...
    public void flowDefinitionAlreadyConfigured() {
        ...
        final var coaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "FLOW_DUP_SETTLE_01",
    ...
    public void invalidAmountNameForTransactionType() {
        ...
        final var coaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "FLOW_AMOUNT_SETTLE_01",
    ...
    public void invalidParticipantForTransactionType() {
        ...
        final var coaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.HUB, "FLOW_HUB_SETTLE_01",
    ...
    public void successful() {
        ...
        final var coaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "FLOW_PAYER_SETTLE_01",
