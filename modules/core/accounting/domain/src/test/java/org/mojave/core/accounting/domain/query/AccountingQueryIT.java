...
public class AccountingQueryIT extends BaseIT {
    ...
    public void coaEntryQuerySuccessful() {
        ...
        final var firstCoaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "ENTRY_QUERY_01",
            "Entry Query One", AccountType.ASSET);
        final var secondCoaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.HUB, "ENTRY_QUERY_02",
            "Entry Query Two", AccountType.REVENUE);

        final var byId = this.coaEntryQuery.get(firstCoaEntryId);
        final var byCoa = this.coaEntryQuery.get(coaId);
        final var byCategory = this.coaEntryQuery.get(ChartEntryCategory.HUB);
    ...
    public void flowDefinitionQuerySuccessful() {
        ...
        final var usdCoaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "FLOW_QUERY_01",
            "Flow Query One", AccountType.ASSET);

        final var eurCoaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "FLOW_QUERY_02",
            "Flow Query Two", AccountType.REVENUE);
    ...
    private AccountQueryFixture createAccountQueryFixture() {
        ...
        final var firstCoaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "ACCOUNT_QUERY_ENTRY_01",
            "Account Query Entry One", AccountType.ASSET);

        final var secondCoaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.HUB, "ACCOUNT_QUERY_ENTRY_02",
