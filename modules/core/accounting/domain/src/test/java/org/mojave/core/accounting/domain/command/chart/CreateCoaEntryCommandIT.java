...
public class CreateCoaEntryCommandIT extends BaseIT {
    ...
    public void coaIdNotFound() {
        ...
        assertThrows(
            ...
            () -> this.createCoaEntryCommand.execute(new CreateCoaEntryCommand.Input(
                new CoaId(Long.MAX_VALUE), ChartEntryCategory.HUB, new CoaEntryCode("HUB_FLOAT"),
                "Hub Float", "Hub Float description", AccountType.ASSET)));
    }
    ...
    public void successful() {
        ...
        final var output = this.createCoaEntryCommand.execute(new CreateCoaEntryCommand.Input(
            coaId, ChartEntryCategory.FSP, new CoaEntryCode("FSP_SETTLEMENT"), "FSP Settlement",
        ...
        assertEquals(ChartEntryCategory.FSP, coaEntry.category());
    ...
    public void coaEntryCodeAlreadyExists() {
        ...
        this.createCoaEntryCommand.execute(new CreateCoaEntryCommand.Input(
            ...
            new CoaEntryCode("DUPLICATE_ENTRY_CODE"),
            "Duplicate Entry Code 01",
            "Duplicate Entry Code 01 description",
            AccountType.ASSET));
        ...
        assertThrows(
            ...
            () -> this.createCoaEntryCommand.execute(new CreateCoaEntryCommand.Input(
                ...
                ChartEntryCategory.FSP,
                new CoaEntryCode("DUPLICATE_ENTRY_CODE"),
                "Duplicate Entry Code 02",
                "Duplicate Entry Code 02 description",
    ...
    public void coaEntryNameAlreadyExists() {
        ...
        this.createCoaEntryCommand.execute(new CreateCoaEntryCommand.Input(
            coaId,
            ChartEntryCategory.FSP,
            new CoaEntryCode("DUPLICATE_ENTRY_NAME_01"),
            "Duplicate Entry Name",
            "Duplicate Entry Name 01 description",
            AccountType.ASSET));
        ...
        assertThrows(
            ...
            () -> this.createCoaEntryCommand.execute(new CreateCoaEntryCommand.Input(
                coaId,
                ChartEntryCategory.FSP,
                new CoaEntryCode("DUPLICATE_ENTRY_NAME_02"),
                "Duplicate Entry Name",
                "Duplicate Entry Name 02 description",
                AccountType.LIABILITY)));
    }
