...
public class AddFlowLineCommandIT extends BaseIT {
    ...
    public void duplicateFlowLineIndex() {
        ...
        final var payerCoaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "DUP_FLOW_PAYER_01",
            "Dup Flow Payer 01", AccountType.ASSET);
        final var payeeCoaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "DUP_FLOW_PAYEE_01",
    ...
    public void successful() {
        ...
        final var payerCoaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "ADD_FLOW_PAYER_01",
            "Add Flow Payer 01", AccountType.ASSET);
        final var payeeCoaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "ADD_FLOW_PAYEE_01",
