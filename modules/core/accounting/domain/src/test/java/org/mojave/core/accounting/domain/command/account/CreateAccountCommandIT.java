...
public class CreateAccountCommandIT extends BaseIT {
    ...
    public void accountCodeAlreadyExists() {
        ...
        final var firstCoaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "FSP_CASH_02", "FSP Cash 02",
            AccountType.ASSET);
        final var secondCoaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "FSP_CASH_03", "FSP Cash 03",
            AccountType.ASSET);
    ...
    public void successful() {
        ...
        final var coaEntryId = this.createCoaEntry(
            this.createCoaEntryCommand, coaId, ChartEntryCategory.FSP, "FSP_CASH_01", "FSP Cash 01",
            AccountType.ASSET);
    ...
    public void ledgerBalanceCreationFailed() {
        ...
        final var coaEntryId = this.createCoaEntry(
            ...
            "LEDGER_FAIL_ENTRY_01",
            "Ledger Fail Entry 01",
            AccountType.ASSET);
