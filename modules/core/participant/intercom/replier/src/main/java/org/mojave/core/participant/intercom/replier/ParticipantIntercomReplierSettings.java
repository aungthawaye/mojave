...
public class ParticipantIntercomReplierSettings
    implements ParticipantIntercomReplierConfiguration.RequiredSettings {
    ...
    public RoutingDataSourceConfigurer.ReadSettings routingDataSourceReadSettings() {
        ...
        final var pool = new RoutingDataSourceConfigurer.ReadSettings.Pool(
            "participant-intercom-replier-read",
    ...
    public RoutingDataSourceConfigurer.WriteSettings routingDataSourceWriteSettings() {
        ...
        final var pool = new RoutingDataSourceConfigurer.WriteSettings.Pool(
            "participant-intercom-replier-write",
    ...
    public RoutingEntityManagerConfigurer.Settings routingEntityManagerSettings() {
        ...
        return new RoutingEntityManagerConfigurer.Settings(
            "participant-intercom-replier", false, false);
    }
