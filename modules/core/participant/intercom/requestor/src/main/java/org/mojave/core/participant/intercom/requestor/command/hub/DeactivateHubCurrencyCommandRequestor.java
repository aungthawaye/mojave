package org.mojave.core.participant.intercom.requestor.command.hub;
...
@Component
public class DeactivateHubCurrencyCommandRequestor implements DeactivateHubCurrencyCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeactivateHubCurrencyCommandRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public DeactivateHubCurrencyCommandRequestor(final Connection connection, final ObjectMapper objectMapper) {
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("DeactivateHubCurrencyCommandRequestor : input: ({})", ObjectLogger.log(input));

        try {

            final var output = CommandRequestor.request(
                this.connection, DeactivateHubCurrencyCommand.SUBJECT_NAME,
                input, Output.class, this.objectMapper);

            LOGGER.info("DeactivateHubCurrencyCommandRequestor : output : ({})", ObjectLogger.log(output));
