...
@Component
public class DeactivateEndpointCommandRequestor implements DeactivateEndpointCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeactivateEndpointCommandRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public DeactivateEndpointCommandRequestor(final Connection connection, final ObjectMapper objectMapper) {
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("DeactivateEndpointCommandRequestor : input: ({})", ObjectLogger.log(input));

        try {

            final var output = CommandRequestor.request(
                this.connection, DeactivateEndpointCommand.SUBJECT_NAME,
                input, Output.class, this.objectMapper);

            LOGGER.info("DeactivateEndpointCommandRequestor : output : ({})", ObjectLogger.log(output));
