...
package org.mojave.core.participant.admin.controller.api.command.hub;
...
public class ActivateHubCurrencyController {
    ...
    @PostMapping("/participant/hubs/activate-currency")
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public ActivateHubCurrencyCommand.Output execute(
        @Valid @RequestBody ActivateHubCurrencyCommand.Input input) {
