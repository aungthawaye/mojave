 ...
 * ===
 */
package org.mojave.core.participant.admin.client.api.command.hub;
...
public class ActivateHubCurrencyInvoker implements ActivateHubCurrencyCommand {
    ...
    public ActivateHubCurrencyInvoker(final ParticipantAdminService.HubCommands hubCommands,
                                      final ObjectMapper objectMapper) {

        Objects.requireNonNull(hubCommands);
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.hubCommands.activateHubCurrency(input),
