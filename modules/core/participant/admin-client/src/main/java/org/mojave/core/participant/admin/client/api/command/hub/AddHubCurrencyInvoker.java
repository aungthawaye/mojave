...
@Component
public class AddHubCurrencyInvoker implements AddHubCurrencyCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(AddHubCurrencyInvoker.class);
