...
@Component
public class AddFspGroupItemInvoker implements AddFspGroupItemCommand {

    private final ParticipantAdminService.FspCommand fspCommand;

    private final ObjectMapper objectMapper;

    public AddFspGroupItemInvoker(final ParticipantAdminService.FspCommand fspCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.fspCommand.addFspGroupItem(input),
