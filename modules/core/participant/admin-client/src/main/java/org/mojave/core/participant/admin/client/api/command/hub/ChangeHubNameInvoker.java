...
@Component
public class ChangeHubNameInvoker implements ChangeHubNameCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeHubNameInvoker.class);
