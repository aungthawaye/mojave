...
@Getter
public class BalanceNotExistException extends UncheckedDomainException {

    public static final String CODE = "BALANCE_NOT_EXIST";

    private static final String TEMPLATE = "Balance does not exist : walletOwnerId ({0}) | currency ({1}).";
    ...
    public static BalanceNotExistException from(final Map<String, String> extras) {
        ...
        return new BalanceNotExistException(walletOwnerId, currency);
    }
