...
public final class WalletExceptionResolver {

    private static final String EXCEPTION_PACKAGE = "org.mojave.core.wallet.contract.exception";

    private WalletExceptionResolver() {
