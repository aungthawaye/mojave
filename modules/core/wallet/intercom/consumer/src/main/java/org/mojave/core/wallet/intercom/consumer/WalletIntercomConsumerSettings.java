package org.mojave.core.wallet.intercom.consumer;
...
public class WalletIntercomConsumerSettings
    implements WalletIntercomConsumerConfiguration.RequiredSettings {
    ...
    public RoutingDataSourceConfigurer.WriteSettings routingDataSourceWriteSettings() {
        ...
        final var pool = new RoutingDataSourceConfigurer.WriteSettings.Pool(
            "wallet-intercom-consumer-write",
    ...
    public RoutingEntityManagerConfigurer.Settings routingEntityManagerSettings() {
        ...
        return new RoutingEntityManagerConfigurer.Settings(
            "wallet-intercom-consumer", false, false);
    }
