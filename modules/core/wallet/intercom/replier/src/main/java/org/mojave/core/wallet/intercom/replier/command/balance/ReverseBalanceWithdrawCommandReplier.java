...
@Component
public class ReverseBalanceWithdrawCommandReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(ReverseBalanceWithdrawCommandReplier.class);
    ...
    public ReverseBalanceWithdrawCommandReplier(final ReverseBalanceWithdrawCommand command,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("ReverseBalanceWithdrawCommandReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("ReverseBalanceWithdrawCommandReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("ReverseBalanceWithdrawCommandReplier : output : ({})", ObjectLogger.log(output));
