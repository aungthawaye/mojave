package org.mojave.core.wallet.intercom.replier.command;
...
@Component
public class CreateWalletCommandReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateWalletCommandReplier.class);
    ...
    public CreateWalletCommandReplier(final CreateWalletCommand command,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("CreateWalletCommandReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("CreateWalletCommandReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("CreateWalletCommandReplier : output : ({})", ObjectLogger.log(output));
