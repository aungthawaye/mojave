...
@Component
public class CommitReservationCommandReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(CommitReservationCommandReplier.class);
    ...
    public CommitReservationCommandReplier(final CommitReservationCommand command,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("CommitReservationCommandReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("CommitReservationCommandReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("CommitReservationCommandReplier : output : ({})", ObjectLogger.log(output));
