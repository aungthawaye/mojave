 ...
 * ===
 */
package org.mojave.core.wallet.intercom.client.api.command.position;
...
public class ReservePositionInvoker implements ReservePositionCommand {
    ...
    public ReservePositionInvoker(final WalletIntercomService.PositionCommand positionCommand,
