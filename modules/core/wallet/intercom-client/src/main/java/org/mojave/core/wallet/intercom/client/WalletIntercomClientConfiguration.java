...
package org.mojave.core.wallet.intercom.client;
...
@ComponentScan(basePackages = {"org.mojave.core.wallet.intercom.client"})
public class WalletIntercomClientConfiguration implements MiscConfiguration.RequiredDependencies {
