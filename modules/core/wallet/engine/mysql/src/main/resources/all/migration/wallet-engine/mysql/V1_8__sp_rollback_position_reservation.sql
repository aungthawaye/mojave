DELIMITER
$$
DROP PROCEDURE IF EXISTS `sp_rollback_position_reservation` $$
CREATE PROCEDURE sp_rollback_position_reservation(
                                     IN p_reservation_id     BIGINT,
                                     IN p_position_update_id BIGINT)
proc_rollback_position_reservation:
BEGIN
    ...
    IF v_not_found OR v_action != 'RESERVE' THEN
        ...
        LEAVE proc_rollback_position_reservation;
    END IF;
