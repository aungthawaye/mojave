...
@Import(
    value = {
        ...
        SettlementIntercomDependencies.class,
        SettlementIntercomSettings.class})
public class SettlementIntercomApplication {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(SettlementIntercomApplication.class)
            ...
            .properties(
                "spring.application.name=settlement-intercom",
    ...
    public WebServerFactoryCustomizer<ConfigurableWebServerFactory> webServerFactoryCustomizer(
        SettlementIntercomConfiguration.TomcatSettings settings) {
