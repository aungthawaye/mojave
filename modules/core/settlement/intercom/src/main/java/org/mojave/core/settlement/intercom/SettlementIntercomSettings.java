...
final class SettlementIntercomSettings implements SettlementIntercomConfiguration.RequiredSettings {

    @Bean
    @Override
    public OpenApiConfiguration.ApiSettings apiSettings() {

        return new OpenApiConfiguration.ApiSettings("Mojave - Settlement - Intercom", "1.0.0");
    }
    ...
    public RoutingDataSourceConfigurer.ReadSettings routingDataSourceReadSettings() {
        ...
        var pool = new RoutingDataSourceConfigurer.ReadSettings.Pool(
            "settlement-intercom-read", Integer.parseInt(System.getenv("READ_DB_MIN_POOL_SIZE")),
    ...
    public RoutingDataSourceConfigurer.WriteSettings routingDataSourceWriteSettings() {
        ...
        var pool = new RoutingDataSourceConfigurer.WriteSettings.Pool(
            "settlement-intercom-write", Integer.parseInt(System.getenv("WRITE_DB_MIN_POOL_SIZE")),
    ...
    public RoutingEntityManagerConfigurer.Settings routingEntityManagerSettings() {
        ...
        return new RoutingEntityManagerConfigurer.Settings("settlement-intercom", false, false);
    }
    ...
    @Bean
    @Override
    public SettlementIntercomConfiguration.TomcatSettings tomcatSettings() {

        return new SettlementIntercomConfiguration.TomcatSettings(
            Integer.parseInt(System.getenv("SETTLEMENT_INTERCOM_PORT")));
    }
