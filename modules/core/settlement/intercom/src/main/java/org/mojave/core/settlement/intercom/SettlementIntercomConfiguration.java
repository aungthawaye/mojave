...
@EnableWebMvc
@EnableAsync
@ComponentScan(basePackages = "org.mojave.core.settlement.intercom.controller")
@Import(
    value = {
...
public final class SettlementIntercomConfiguration extends JsonWebMvcConfigurationSupport {

    public SettlementIntercomConfiguration(tools.jackson.databind.json.JsonMapper jsonMapper) {
