...
@EnableAsync
@ComponentScan(basePackages = "org.mojave.core.settlement.service.controller")
@Import(
    value = {
...
public final class SettlementServiceConfiguration extends JsonWebMvcConfigurationSupport {

    public SettlementServiceConfiguration(tools.jackson.databind.json.JsonMapper jsonMapper) {
