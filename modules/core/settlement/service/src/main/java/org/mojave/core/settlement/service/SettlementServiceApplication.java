...
@Import(
    value = {
        SettlementServiceConfiguration.class,
        SettlementServiceDependencies.class,
        SettlementServiceSettings.class})
public class SettlementServiceApplication {

    private static final Logger LOGGER = LoggerFactory.getLogger(SettlementServiceApplication.class);
    ...
    public WebServerFactoryCustomizer<ConfigurableWebServerFactory> webServerFactoryCustomizer(
        SettlementServiceConfiguration.TomcatSettings settings) {
