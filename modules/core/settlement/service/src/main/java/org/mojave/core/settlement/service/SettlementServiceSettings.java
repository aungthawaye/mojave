...
package org.mojave.core.settlement.service;
...
final class SettlementServiceSettings implements SettlementServiceConfiguration.RequiredSettings {

    @Bean
    @Override
    public OpenApiConfiguration.ApiSettings apiSettings() {

        return new OpenApiConfiguration.ApiSettings("Mojave - Settlement - Service", "1.0.0");
    }
    ...
    public RoutingDataSourceConfigurer.ReadSettings routingDataSourceReadSettings() {
        ...
        var pool = new RoutingDataSourceConfigurer.ReadSettings.Pool(
            "settlement-service-read", Integer.parseInt(System.getenv("READ_DB_MIN_POOL_SIZE")),
    ...
    public RoutingDataSourceConfigurer.WriteSettings routingDataSourceWriteSettings() {
        ...
        var pool = new RoutingDataSourceConfigurer.WriteSettings.Pool(
            "settlement-service-write", Integer.parseInt(System.getenv("WRITE_DB_MIN_POOL_SIZE")),
    ...
    public RoutingEntityManagerConfigurer.Settings routingEntityManagerSettings() {
        ...
        return new RoutingEntityManagerConfigurer.Settings("settlement-service", false, false);
    }
    ...
    @Bean
    @Override
    public SettlementServiceConfiguration.TomcatSettings tomcatSettings() {

        return new SettlementServiceConfiguration.TomcatSettings(
            Integer.parseInt(System.getenv("SETTLEMENT_SERVICE_PORT")));
    }
