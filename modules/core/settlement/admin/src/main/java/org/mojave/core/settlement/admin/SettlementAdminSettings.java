...
final class SettlementAdminSettings implements SettlementAdminConfiguration.RequiredSettings {

    @Bean
    @Override
    public OpenApiConfiguration.ApiSettings apiSettings() {

        return new OpenApiConfiguration.ApiSettings("Mojave - Settlement - Admin", "1.0.0");
    }
    ...
    public RoutingDataSourceConfigurer.ReadSettings routingDataSourceReadSettings() {
        ...
        var pool = new RoutingDataSourceConfigurer.ReadSettings.Pool(
            "settlement-admin-read", Integer.parseInt(System.getenv("READ_DB_MIN_POOL_SIZE")),
    ...
    public RoutingDataSourceConfigurer.WriteSettings routingDataSourceWriteSettings() {
        ...
        var pool = new RoutingDataSourceConfigurer.WriteSettings.Pool(
            "settlement-admin-write", Integer.parseInt(System.getenv("WRITE_DB_MIN_POOL_SIZE")),
    ...
    public RoutingEntityManagerConfigurer.Settings routingEntityManagerSettings() {
        ...
        return new RoutingEntityManagerConfigurer.Settings("settlement-admin", false, false);
    }
    ...
    @Bean
    @Override
    public SettlementAdminConfiguration.TomcatSettings tomcatSettings() {

        return new SettlementAdminConfiguration.TomcatSettings(
            Integer.parseInt(System.getenv("SETTLEMENT_ADMIN_PORT")));
    }
