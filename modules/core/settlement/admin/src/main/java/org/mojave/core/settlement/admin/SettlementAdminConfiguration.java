...
public final class SettlementAdminConfiguration extends JsonWebMvcConfigurationSupport {

    public SettlementAdminConfiguration(tools.jackson.databind.json.JsonMapper jsonMapper) {
