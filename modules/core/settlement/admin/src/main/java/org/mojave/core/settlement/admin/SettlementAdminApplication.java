...
@Import(
    value = {
        ...
        SettlementAdminDependencies.class,
        SettlementAdminSettings.class})
public class SettlementAdminApplication {
    ...
    public static void main(String[] args) {
        ...
        new SpringApplicationBuilder(SettlementAdminApplication.class)
            ...
            .properties(
                "spring.application.name=settlement-admin",
    ...
    public WebServerFactoryCustomizer<ConfigurableWebServerFactory> webServerFactoryCustomizer(
        SettlementAdminConfiguration.TomcatSettings settings) {
