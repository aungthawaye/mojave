...
public interface ActivateSettlementModelCommand {

    String SUBJECT_NAME = "sub-settlement.activate-settlement-model-command";

    String TOPIC_NAME = "tp-settlement.activate-settlement-model-command";
