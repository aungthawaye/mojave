...
@Getter
public class SettlementModelDefinitionNotConfiguredException extends UncheckedDomainException {

    public static final String CODE = "SETTLEMENT_MODEL_DEFINITION_NOT_CONFIGURED";

    private static final String TEMPLATE =
        "Settlement Model Definition for scenario ({0}), currency ({1}), FSP group ({2}) and transaction period ({3}) is not configured.";
    ...
    public SettlementModelDefinitionNotConfiguredException(final ScenarioType scenario,
    ...
    public static SettlementModelDefinitionNotConfiguredException from(final Map<String, String> extras) {

        return new SettlementModelDefinitionNotConfiguredException(
