...
@Getter
public class SettlementDefinitionTimeRangeOverlappingException extends UncheckedDomainException {

    public static final String CODE = "SETTLEMENT_DEFINITION_TIME_RANGE_OVERLAPPING";

    private static final String TEMPLATE = "Settlement definition time range overlaps for currency ({0}), payer group ({1}), payee group ({2}).";
    ...
    public SettlementDefinitionTimeRangeOverlappingException(final Currency currency,
    ...
    public static SettlementDefinitionTimeRangeOverlappingException from(final Map<String, String> extras) {
        ...
        return new SettlementDefinitionTimeRangeOverlappingException(
