...
public interface TerminateSettlementModelCommand {

    String SUBJECT_NAME = "sub-settlement.terminate-settlement-model-command";

    String TOPIC_NAME = "tp-settlement.terminate-settlement-model-command";
