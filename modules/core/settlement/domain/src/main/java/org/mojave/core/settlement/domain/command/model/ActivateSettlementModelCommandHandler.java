...
import org.mojave.core.settlement.contract.command.model.ActivateSettlementModelCommand;
...
@Service
public class ActivateSettlementModelCommandHandler implements ActivateSettlementModelCommand {

    private final SettlementModelRepository settlementModelRepository;

    public ActivateSettlementModelCommandHandler(
