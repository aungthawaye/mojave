...
package org.mojave.core.settlement.intercom.client.api.command.filtergroup;
...
@Component
public class RemoveFilterItemInvoker implements RemoveFilterItemCommand {

    private final SettlementIntercomService.FilterGroupCommand filterGroupCommand;

    private final ObjectMapper objectMapper;

    public RemoveFilterItemInvoker(final SettlementIntercomService.FilterGroupCommand filterGroupCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.filterGroupCommand.removeItem(input),
