...
package org.mojave.core.settlement.intercom.client.api.query;
...
public class SettlementRecordQueryInvoker implements SettlementRecordQuery {
    ...
    private final SettlementIntercomService.RecordQuery recordQuery;

    private final ObjectMapper objectMapper;

    public SettlementRecordQueryInvoker(final SettlementIntercomService.RecordQuery recordQuery,
