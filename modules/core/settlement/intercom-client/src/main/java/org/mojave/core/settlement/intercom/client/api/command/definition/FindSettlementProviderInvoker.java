...
@Component
public class FindSettlementProviderInvoker implements FindSettlementProviderCommand {

    private final SettlementIntercomService.DefinitionCommand definitionCommand;

    private final ObjectMapper objectMapper;

    public FindSettlementProviderInvoker(final SettlementIntercomService.DefinitionCommand definitionCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.definitionCommand.findProvider(input),
