...
@Component
public class UpdatePreparationResultInvoker implements UpdatePreparationResultCommand {

    private final SettlementIntercomService.RecordCommand recordCommand;

    private final ObjectMapper objectMapper;

    public UpdatePreparationResultInvoker(final SettlementIntercomService.RecordCommand recordCommand,
