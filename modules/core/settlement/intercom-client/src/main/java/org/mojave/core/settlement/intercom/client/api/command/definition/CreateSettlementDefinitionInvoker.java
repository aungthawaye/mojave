...
@Component
public class CreateSettlementDefinitionInvoker implements CreateSettlementDefinitionCommand {

    private final SettlementIntercomService.DefinitionCommand definitionCommand;

    private final ObjectMapper objectMapper;

    public CreateSettlementDefinitionInvoker(final SettlementIntercomService.DefinitionCommand definitionCommand,
