...
@Component
public class ActivateSettlementDefinitionInvoker implements ActivateSettlementDefinitionCommand {

    private final SettlementIntercomService.DefinitionCommand definitionCommand;

    private final ObjectMapper objectMapper;

    public ActivateSettlementDefinitionInvoker(final SettlementIntercomService.DefinitionCommand definitionCommand,
