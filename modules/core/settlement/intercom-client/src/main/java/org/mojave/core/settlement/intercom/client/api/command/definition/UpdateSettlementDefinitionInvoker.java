...
@Component
public class UpdateSettlementDefinitionInvoker implements UpdateSettlementDefinitionCommand {

    private final SettlementIntercomService.DefinitionCommand definitionCommand;

    private final ObjectMapper objectMapper;

    public UpdateSettlementDefinitionInvoker(final SettlementIntercomService.DefinitionCommand definitionCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.definitionCommand.update(input),
