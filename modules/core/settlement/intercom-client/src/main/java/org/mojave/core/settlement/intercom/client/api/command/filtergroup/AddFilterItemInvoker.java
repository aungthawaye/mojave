...
@Component
public class AddFilterItemInvoker implements AddFilterItemCommand {

    private final SettlementIntercomService.FilterGroupCommand filterGroupCommand;

    private final ObjectMapper objectMapper;

    public AddFilterItemInvoker(final SettlementIntercomService.FilterGroupCommand filterGroupCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.filterGroupCommand.addItem(input),
