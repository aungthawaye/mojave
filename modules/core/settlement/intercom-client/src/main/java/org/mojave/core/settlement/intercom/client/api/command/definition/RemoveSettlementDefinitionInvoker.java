...
package org.mojave.core.settlement.intercom.client.api.command.definition;
...
@Component
public class RemoveSettlementDefinitionInvoker implements RemoveSettlementDefinitionCommand {

    private final SettlementIntercomService.DefinitionCommand definitionCommand;

    private final ObjectMapper objectMapper;

    public RemoveSettlementDefinitionInvoker(final SettlementIntercomService.DefinitionCommand definitionCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.definitionCommand.remove(input),
