...
@Component
public class RequestSettlementInitiationInvoker implements RequestSettlementInitiationCommand {

    private final SettlementIntercomService.RecordCommand recordCommand;

    private final ObjectMapper objectMapper;

    public RequestSettlementInitiationInvoker(final SettlementIntercomService.RecordCommand recordCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.recordCommand.requestInitiation(input),
