...
@Component
public class HandleSettlementCompletionInvoker implements HandleSettlementCompletionCommand {

    private final SettlementIntercomService.RecordCommand recordCommand;

    private final ObjectMapper objectMapper;

    public HandleSettlementCompletionInvoker(final SettlementIntercomService.RecordCommand recordCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.recordCommand.complete(input),
