...
@Component
public class CompleteSettlementInvoker implements CompleteSettlementCommand {

    private final SettlementIntercomService.RecordCommand recordCommand;

    private final ObjectMapper objectMapper;

    public CompleteSettlementInvoker(final SettlementIntercomService.RecordCommand recordCommand,
