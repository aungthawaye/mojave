...
package org.mojave.core.settlement.intercom.client.api.command.record;
...
@Component
public class HandleSettlementPreparationInvoker implements HandleSettlementPreparationCommand {

    private final SettlementIntercomService.RecordCommand recordCommand;

    private final ObjectMapper objectMapper;

    public HandleSettlementPreparationInvoker(final SettlementIntercomService.RecordCommand recordCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.recordCommand.updatePreparation(input),
