...
@Component
public class RemoveFilterGroupInvoker implements RemoveFilterGroupCommand {

    private final SettlementIntercomService.FilterGroupCommand filterGroupCommand;

    private final ObjectMapper objectMapper;

    public RemoveFilterGroupInvoker(final SettlementIntercomService.FilterGroupCommand filterGroupCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.filterGroupCommand.remove(input),
