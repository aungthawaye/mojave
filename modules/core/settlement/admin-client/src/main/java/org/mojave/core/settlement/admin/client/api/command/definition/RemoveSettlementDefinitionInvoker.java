...
public class RemoveSettlementDefinitionInvoker implements RemoveSettlementDefinitionCommand {
    ...
    private final SettlementAdminService.DefinitionCommand definitionCommand;

    private final ObjectMapper objectMapper;

    public RemoveSettlementDefinitionInvoker(final SettlementAdminService.DefinitionCommand definitionCommand,
