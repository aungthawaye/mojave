...
public class FilterItemId extends EntityId<Long> {
    ...
    public static class Deserializer extends ValueDeserializer<FilterItemId> {

        @Override
        public FilterItemId deserialize(JsonParser p, DeserializationContext ctx)
            ...
            try {
                return new FilterItemId(Long.parseLong(text));
