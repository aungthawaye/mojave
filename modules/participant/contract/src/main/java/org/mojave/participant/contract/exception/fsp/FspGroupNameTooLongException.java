...
@Getter
public class FspGroupNameTooLongException extends UncheckedDomainException {
    ...
    public static FspGroupNameTooLongException from(final Map<String, String> extras) {

        return new FspGroupNameTooLongException();
    }
