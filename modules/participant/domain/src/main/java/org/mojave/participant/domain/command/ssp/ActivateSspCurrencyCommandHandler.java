...
@Service
@Primary
public class ActivateSspCurrencyCommandHandler implements ActivateSspCurrencyCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(
        ActivateSspCurrencyCommandHandler.class);

    private final SspRepository sspRepository;

    public ActivateSspCurrencyCommandHandler(final SspRepository sspRepository) {
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ActivateSspCurrencyCommand : input: ({})", ObjectLogger.log(input));
        ...
        var optCurrency = ssp.activate(input.currency());
        ...
        LOGGER.info("ActivateSspCurrencyCommand : output: ({})", ObjectLogger.log(output));
