...
@Service
@Primary
public class ChangeSspNameCommandHandler implements ChangeSspNameCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeSspNameCommandHandler.class);

    private final SspRepository sspRepository;

    public ChangeSspNameCommandHandler(final SspRepository sspRepository) {
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ChangeSspNameCommand : input: ({})", ObjectLogger.log(input));
        ...
        LOGGER.info("ChangeSspNameCommand : output : ({})", ObjectLogger.log(output));
