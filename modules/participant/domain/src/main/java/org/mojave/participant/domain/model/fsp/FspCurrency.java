...
import org.mojave.common.datatype.converter.identifier.participant.FspCurrencyIdJavaType;
...
import org.mojave.participant.contract.data.FspCurrencyData;
...
public final class FspCurrency extends JpaEntity<FspCurrencyId>
    ...
    @JoinColumn(
        name = "fsp_id",
        nullable = false,
        foreignKey = @ForeignKey(name = "pcp_fsp_pcp_fsp_currency_FK"))
    private Fsp fsp;
