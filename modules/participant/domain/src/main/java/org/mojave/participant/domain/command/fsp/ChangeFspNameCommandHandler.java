...
@Service
@Primary
public class ChangeFspNameCommandHandler implements ChangeFspNameCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeFspNameCommandHandler.class);

    private final FspRepository fspRepository;

    public ChangeFspNameCommandHandler(FspRepository fspRepository) {
