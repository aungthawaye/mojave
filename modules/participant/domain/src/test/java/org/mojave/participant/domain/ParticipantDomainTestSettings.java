...
public class ParticipantDomainTestSettings
    implements ParticipantDomainConfiguration.RequiredSettings {
    ...
    public RoutingDataSourceConfigurer.ReadSettings routingDataSourceReadSettings() {
        ...
        final var pool = new RoutingDataSourceConfigurer.ReadSettings.Pool(
            "mojave-participant-read", READ_DB_MIN_POOL_SIZE, READ_DB_MAX_POOL_SIZE);
    ...
    public RoutingDataSourceConfigurer.WriteSettings routingDataSourceWriteSettings() {
        ...
        final var pool = new RoutingDataSourceConfigurer.WriteSettings.Pool(
            "mojave-participant-write", WRITE_DB_MIN_POOL_SIZE, WRITE_DB_MAX_POOL_SIZE);
