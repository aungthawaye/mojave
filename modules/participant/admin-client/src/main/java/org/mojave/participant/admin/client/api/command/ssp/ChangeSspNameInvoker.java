...
@Component
public class ChangeSspNameInvoker implements ChangeSspNameCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeSspNameInvoker.class);

    private final ParticipantAdminService.SspCommand sspCommand;

    private final ObjectMapper objectMapper;

    public ChangeSspNameInvoker(final ParticipantAdminService.SspCommand sspCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.sspCommand.changeSspName(input),
