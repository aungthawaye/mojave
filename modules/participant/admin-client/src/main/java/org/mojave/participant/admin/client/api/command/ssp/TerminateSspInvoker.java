...
@Component
public class TerminateSspInvoker implements TerminateSspCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(TerminateSspInvoker.class);

    private final ParticipantAdminService.SspCommand sspCommand;

    private final ObjectMapper objectMapper;

    public TerminateSspInvoker(final ParticipantAdminService.SspCommand sspCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.sspCommand.terminateSsp(input),
