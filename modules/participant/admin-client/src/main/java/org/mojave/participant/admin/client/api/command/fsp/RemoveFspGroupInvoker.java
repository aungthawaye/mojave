...
@Component
public class RemoveFspGroupInvoker implements RemoveFspGroupCommand {

    private final ParticipantAdminService.FspCommand fspCommand;

    private final ObjectMapper objectMapper;

    public RemoveFspGroupInvoker(final ParticipantAdminService.FspCommand fspCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.fspCommand.removeFspGroup(input),
