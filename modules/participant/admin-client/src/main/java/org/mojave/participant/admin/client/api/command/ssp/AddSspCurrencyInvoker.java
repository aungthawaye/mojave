...
@Component
public class AddSspCurrencyInvoker implements AddSspCurrencyCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(AddSspCurrencyInvoker.class);

    private final ParticipantAdminService.SspCommand sspCommand;

    private final ObjectMapper objectMapper;

    public AddSspCurrencyInvoker(final ParticipantAdminService.SspCommand sspCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.sspCommand.addSspCurrency(input),
