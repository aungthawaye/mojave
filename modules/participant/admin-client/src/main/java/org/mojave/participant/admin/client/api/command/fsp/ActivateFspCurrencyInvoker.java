...
package org.mojave.participant.admin.client.api.command.fsp;
...
public class ActivateFspCurrencyInvoker implements ActivateFspCurrencyCommand {
    ...
    public ActivateFspCurrencyInvoker(final ParticipantAdminService.FspCommand fspCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.fspCommand.activateFspCurrency(input),
