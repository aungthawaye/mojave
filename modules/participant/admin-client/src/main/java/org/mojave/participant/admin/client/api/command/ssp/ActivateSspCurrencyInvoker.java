...
package org.mojave.participant.admin.client.api.command.ssp;
...
@Component
public class ActivateSspCurrencyInvoker implements ActivateSspCurrencyCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateSspCurrencyInvoker.class);

    private final ParticipantAdminService.SspCommand sspCommand;

    private final ObjectMapper objectMapper;

    public ActivateSspCurrencyInvoker(final ParticipantAdminService.SspCommand sspCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.sspCommand.activateSspCurrency(input),
