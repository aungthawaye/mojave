...
@Component
public class ChangeFspEndpointInvoker implements ChangeFspEndpointCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeFspEndpointInvoker.class);

    private final ParticipantAdminService.FspCommand fspCommand;

    private final ObjectMapper objectMapper;

    public ChangeFspEndpointInvoker(final ParticipantAdminService.FspCommand fspCommand,
