...
@Component
public class ActivateSspInvoker implements ActivateSspCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateSspInvoker.class);

    private final ParticipantAdminService.SspCommand sspCommand;

    private final ObjectMapper objectMapper;

    public ActivateSspInvoker(final ParticipantAdminService.SspCommand sspCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.sspCommand.activateSsp(input),
