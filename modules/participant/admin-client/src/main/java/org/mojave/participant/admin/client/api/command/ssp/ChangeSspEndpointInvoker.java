...
@Component
public class ChangeSspEndpointInvoker implements ChangeSspEndpointCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeSspEndpointInvoker.class);

    private final ParticipantAdminService.SspCommand sspCommand;

    private final ObjectMapper objectMapper;

    public ChangeSspEndpointInvoker(final ParticipantAdminService.SspCommand sspCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.sspCommand.changeSspEndpoint(input),
