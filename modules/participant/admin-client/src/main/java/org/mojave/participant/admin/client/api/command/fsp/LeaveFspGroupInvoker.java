...
@Component
public class LeaveFspGroupInvoker implements LeaveFspGroupCommand {

    private final ParticipantAdminService.FspCommand fspCommand;

    private final ObjectMapper objectMapper;

    public LeaveFspGroupInvoker(final ParticipantAdminService.FspCommand fspCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.fspCommand.leaveFspGroup(input),
