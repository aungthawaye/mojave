...
@Component
public class JoinFspGroupInvoker implements JoinFspGroupCommand {

    private final ParticipantAdminService.FspCommand fspCommand;

    private final ObjectMapper objectMapper;

    public JoinFspGroupInvoker(final ParticipantAdminService.FspCommand fspCommand,
    ...
    public Output execute(final Input input) {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.fspCommand.joinFspGroup(input),
