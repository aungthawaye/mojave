...
@RestController
public class DeactivateSspCurrencyController {

    private static final Logger LOGGER = LoggerFactory.getLogger(
        DeactivateSspCurrencyController.class);

    private final DeactivateSspCurrencyCommand deactivateSspCurrencyCommand;

    public DeactivateSspCurrencyController(final DeactivateSspCurrencyCommand deactivateSspCurrencyCommand) {
    ...
    public DeactivateSspCurrencyCommand.Output execute(
        @Valid @RequestBody final DeactivateSspCurrencyCommand.Input input) {

        return this.deactivateSspCurrencyCommand.execute(input);
    }
