...
package org.mojave.participant.admin;
...
final class ParticipantAdminSettings implements ParticipantAdminConfiguration.RequiredSettings {
    ...
    public RoutingDataSourceConfigurer.ReadSettings routingDataSourceReadSettings() {
        ...
        var pool = new RoutingDataSourceConfigurer.ReadSettings.Pool(
            "participant-admin-read", Integer.parseInt(System.getenv("READ_DB_MIN_POOL_SIZE")),
    ...
    public RoutingDataSourceConfigurer.WriteSettings routingDataSourceWriteSettings() {
        ...
        var pool = new RoutingDataSourceConfigurer.WriteSettings.Pool(
            "participant-admin-write", Integer.parseInt(System.getenv("WRITE_DB_MIN_POOL_SIZE")),
