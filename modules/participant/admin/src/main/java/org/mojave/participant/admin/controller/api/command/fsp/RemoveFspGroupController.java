...
@RestController
public class RemoveFspGroupController {

    private static final Logger LOGGER = LoggerFactory.getLogger(
        RemoveFspGroupController.class.getName());

    private final RemoveFspGroupCommand removeFspGroupCommand;

    public RemoveFspGroupController(final RemoveFspGroupCommand removeFspGroupCommand) {
    ...
    @PostMapping("/participant/fsps/remove-fsp-group")
