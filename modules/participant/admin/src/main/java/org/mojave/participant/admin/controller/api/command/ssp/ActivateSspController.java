...
public class ActivateSspController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateSspController.class);
    ...
    @ResponseBody
    public ActivateSspCommand.Output execute(
        @Valid @RequestBody final ActivateSspCommand.Input input) {

        return this.activateSspCommand.execute(input);
    }
