...
public class BalanceIdJavaType extends AbstractClassJavaType<BalanceId> {

    public static final BalanceIdJavaType INSTANCE = new BalanceIdJavaType();

    public BalanceIdJavaType() {
