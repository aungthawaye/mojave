...
package org.mojave.transaction.intercom.client;
...
@ComponentScan(basePackages = {"org.mojave.transaction.intercom.client"})
public class TransactionIntercomClientConfiguration
