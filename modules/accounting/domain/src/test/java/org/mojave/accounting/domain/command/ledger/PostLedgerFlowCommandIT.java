...
public class PostLedgerFlowCommandIT extends BaseIT {
    ...
    public void duplicatePostingInLedger() {
        ...
        this.testLedger.failNextPost(
            new Ledger.DuplicatePostingException(
                fixture.payerAccountId(), Side.DEBIT, transactionId));
    ...
    public void insufficientBalanceInAccount() {
        ...
        this.testLedger.failNextPost(new Ledger.InsufficientBalanceException(
            fixture.payerAccountId(), Side.DEBIT, new BigDecimal("100.00"),
            new Ledger.DrCr(BigDecimal.ZERO, new BigDecimal("10.00")), transactionId));
    ...
    public void overdraftLimitReachedInAccount() {
        ...
        final var fixture = this.createTransferPostingFixture(
            "POST_LEDGER_OVERDRAFT", Currency.USD);
    ...
    private PostLedgerFlowCommand.Input buildTransferInput(final PostingFixture fixture,
        ...
        return new PostLedgerFlowCommand.Input(
            TransactionType.FUND_TRANSFER, Currency.USD, transactionId,
            Instant.parse("2026-01-01T00:00:00Z"), participants, amounts);
    }
    ...
    private PostingFixture createTransferPostingFixture(final String prefix,
        ...
        final var payerAccountId = this.createAccount(
            ...
            this.code(prefix, "ACC01"), prefix + " Account 01");

        final var payeeAccountId = this.createAccount(
            this.createAccountCommand, payeeCoaEntryId, payeeOwnerId.getId(), currency,
            this.code(prefix, "ACC02"), prefix + " Account 02");
