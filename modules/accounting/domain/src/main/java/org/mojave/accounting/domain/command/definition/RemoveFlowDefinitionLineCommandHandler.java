...
@Service
public class RemoveFlowDefinitionLineCommandHandler implements RemoveFlowDefinitionLineCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(
        RemoveFlowDefinitionLineCommandHandler.class);

    private final FlowDefinitionRepository flowDefinitionRepository;

    public RemoveFlowDefinitionLineCommandHandler(final FlowDefinitionRepository flowDefinitionRepository) {
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("RemoveFlowDefinitionLineCommand : input: ({})", ObjectLogger.log(input));
        ...
        definition.removeFlowDefinitionLine(input.flowDefinitionLineId());

        this.flowDefinitionRepository.save(definition);
        final var output = new Output(definition.getId());

        LOGGER.info("RemoveFlowDefinitionLineCommand : output : ({})", ObjectLogger.log(output));
