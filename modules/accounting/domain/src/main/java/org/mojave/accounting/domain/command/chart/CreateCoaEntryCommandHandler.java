...
@Service
public class CreateCoaEntryCommandHandler implements CreateCoaEntryCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(
        CreateCoaEntryCommandHandler.class);

    private final CoaRepository coaRepository;

    public CreateCoaEntryCommandHandler(CoaRepository coaRepository) {
    ...
    public Output execute(Input input) {
        ...
        LOGGER.info("CreateCoaEntryCommand : output : ({})", ObjectLogger.log(output));
