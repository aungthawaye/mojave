...
@Component
public class CreateAccountByCategoryRequestor implements CreateAccountByCategoryCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateAccountByCategoryRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public CreateAccountByCategoryRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("CreateAccountByCategoryRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("CreateAccountByCategoryRequestor : output : ({})", ObjectLogger.log(output));
