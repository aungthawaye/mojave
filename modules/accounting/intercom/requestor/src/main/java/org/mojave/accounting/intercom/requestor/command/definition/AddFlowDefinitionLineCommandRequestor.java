...
import org.mojave.accounting.contract.command.definition.AddFlowDefinitionLineCommand;
...
@Component
public class AddFlowDefinitionLineCommandRequestor implements AddFlowDefinitionLineCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(AddFlowDefinitionLineCommandRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public AddFlowDefinitionLineCommandRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("AddFlowDefinitionLineCommandRequestor : input: ({})", ObjectLogger.log(input));

        try {

            final var output = CommandRequestor.request(
                this.connection, AddFlowDefinitionLineCommand.SUBJECT_NAME,
                input, Output.class, this.objectMapper);

            LOGGER.info("AddFlowDefinitionLineCommandRequestor : output : ({})", ObjectLogger.log(output));
