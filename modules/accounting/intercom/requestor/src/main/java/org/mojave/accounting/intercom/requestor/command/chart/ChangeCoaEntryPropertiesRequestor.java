...
@Component
public class ChangeCoaEntryPropertiesRequestor implements ChangeCoaEntryPropertiesCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeCoaEntryPropertiesRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public ChangeCoaEntryPropertiesRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ChangeCoaEntryPropertiesRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("ChangeCoaEntryPropertiesRequestor : output : ({})", ObjectLogger.log(output));
