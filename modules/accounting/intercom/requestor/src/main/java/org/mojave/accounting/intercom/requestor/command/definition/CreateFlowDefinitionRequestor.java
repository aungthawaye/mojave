...
@Component
public class CreateFlowDefinitionRequestor implements CreateFlowDefinitionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateFlowDefinitionRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public CreateFlowDefinitionRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("CreateFlowDefinitionRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("CreateFlowDefinitionRequestor : output : ({})", ObjectLogger.log(output));
