...
@Component
public class DeactivateAccountRequestor implements DeactivateAccountCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeactivateAccountRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public DeactivateAccountRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("DeactivateAccountRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("DeactivateAccountRequestor : output : ({})", ObjectLogger.log(output));
