...
@Component
public class ChangeCoaNameRequestor implements ChangeCoaNameCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeCoaNameRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public ChangeCoaNameRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ChangeCoaNameRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("ChangeCoaNameRequestor : output : ({})", ObjectLogger.log(output));
