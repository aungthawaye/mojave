...
@Component
public class ActivateFlowDefinitionRequestor implements ActivateFlowDefinitionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateFlowDefinitionRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public ActivateFlowDefinitionRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ActivateFlowDefinitionRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("ActivateFlowDefinitionRequestor : output : ({})", ObjectLogger.log(output));
