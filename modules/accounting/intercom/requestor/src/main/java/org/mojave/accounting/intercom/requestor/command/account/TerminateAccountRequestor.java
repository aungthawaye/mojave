...
@Component
public class TerminateAccountRequestor implements TerminateAccountCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(TerminateAccountRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public TerminateAccountRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("TerminateAccountRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("TerminateAccountRequestor : output : ({})", ObjectLogger.log(output));
