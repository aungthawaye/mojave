...
@Component
public class CreateCoaEntryRequestor implements CreateCoaEntryCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateCoaEntryRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public CreateCoaEntryRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("CreateCoaEntryRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("CreateCoaEntryRequestor : output : ({})", ObjectLogger.log(output));
