...
@Component
public class CreateCoaRequestor implements CreateCoaCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateCoaRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public CreateCoaRequestor(final Connection connection, final ObjectMapper objectMapper) {
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("CreateCoaRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("CreateCoaRequestor : output : ({})", ObjectLogger.log(output));
