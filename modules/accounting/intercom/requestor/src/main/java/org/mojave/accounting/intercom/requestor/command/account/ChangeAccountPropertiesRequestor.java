...
@Component
public class ChangeAccountPropertiesRequestor implements ChangeAccountPropertiesCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeAccountPropertiesRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public ChangeAccountPropertiesRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ChangeAccountPropertiesRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("ChangeAccountPropertiesRequestor : output : ({})", ObjectLogger.log(output));
