...
@Component
public class ActivateAccountRequestor implements ActivateAccountCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateAccountRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public ActivateAccountRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ActivateAccountRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("ActivateAccountRequestor : output : ({})", ObjectLogger.log(output));
