...
@Component
public class ChangeFlowDefinitionPropertiesRequestor implements ChangeFlowDefinitionPropertiesCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeFlowDefinitionPropertiesRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public ChangeFlowDefinitionPropertiesRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ChangeFlowDefinitionPropertiesRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("ChangeFlowDefinitionPropertiesRequestor : output : ({})", ObjectLogger.log(output));
