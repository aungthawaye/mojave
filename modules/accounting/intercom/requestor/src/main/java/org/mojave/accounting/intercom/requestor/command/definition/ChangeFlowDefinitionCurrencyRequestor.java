...
@Component
public class ChangeFlowDefinitionCurrencyRequestor implements ChangeFlowDefinitionCurrencyCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeFlowDefinitionCurrencyRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public ChangeFlowDefinitionCurrencyRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ChangeFlowDefinitionCurrencyRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("ChangeFlowDefinitionCurrencyRequestor : output : ({})", ObjectLogger.log(output));
