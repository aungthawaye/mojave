...
@Component
public class PostAccountingFlowRequestor implements PostAccountingFlowCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(PostAccountingFlowRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public PostAccountingFlowRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("PostAccountingFlowRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("PostAccountingFlowRequestor : output : ({})", ObjectLogger.log(output));
