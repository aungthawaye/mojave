...
@Component
public class CreateAccountRequestor implements CreateAccountCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateAccountRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public CreateAccountRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("CreateAccountRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("CreateAccountRequestor : output : ({})", ObjectLogger.log(output));
