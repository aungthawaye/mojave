...
@Component
public class DeactivateFlowDefinitionRequestor implements DeactivateFlowDefinitionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeactivateFlowDefinitionRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public DeactivateFlowDefinitionRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("DeactivateFlowDefinitionRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("DeactivateFlowDefinitionRequestor : output : ({})", ObjectLogger.log(output));
