...
@Component
public class TerminateFlowDefinitionRequestor implements TerminateFlowDefinitionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(TerminateFlowDefinitionRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public TerminateFlowDefinitionRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("TerminateFlowDefinitionRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("TerminateFlowDefinitionRequestor : output : ({})", ObjectLogger.log(output));
