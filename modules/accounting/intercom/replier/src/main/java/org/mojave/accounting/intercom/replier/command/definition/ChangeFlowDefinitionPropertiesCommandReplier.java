...
@Component
public class ChangeFlowDefinitionPropertiesCommandReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeFlowDefinitionPropertiesCommandReplier.class);
    ...
    public ChangeFlowDefinitionPropertiesCommandReplier(final ChangeFlowDefinitionPropertiesCommand changeFlowDefinitionPropertiesCommand,
        ...
        this.connection.createDispatcher(this::handle).subscribe(ChangeFlowDefinitionPropertiesCommand.SUBJECT_NAME);
    }
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("ChangeFlowDefinitionPropertiesCommandReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            final var input = this.objectMapper.readValue(
                message.getData(), ChangeFlowDefinitionPropertiesCommand.Input.class);

            LOGGER.info("ChangeFlowDefinitionPropertiesCommandReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("ChangeFlowDefinitionPropertiesCommandReplier : output : ({})", ObjectLogger.log(output));
