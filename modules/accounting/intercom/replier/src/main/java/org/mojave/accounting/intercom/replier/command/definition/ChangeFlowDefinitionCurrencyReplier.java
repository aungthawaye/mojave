...
@Component
public class ChangeFlowDefinitionCurrencyReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeFlowDefinitionCurrencyReplier.class);
    ...
    public ChangeFlowDefinitionCurrencyReplier(final ChangeFlowDefinitionCurrencyCommand changeFlowDefinitionCurrencyCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("ChangeFlowDefinitionCurrencyReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("ChangeFlowDefinitionCurrencyReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("ChangeFlowDefinitionCurrencyReplier : output : ({})", ObjectLogger.log(output));
