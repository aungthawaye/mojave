...
@Component
public class TerminateAccountReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(TerminateAccountReplier.class);
    ...
    public TerminateAccountReplier(final TerminateAccountCommand terminateAccountCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("TerminateAccountReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("TerminateAccountReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("TerminateAccountReplier : output : ({})", ObjectLogger.log(output));
