...
@Component
public class ChangeCoaNameReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeCoaNameReplier.class);
    ...
    public ChangeCoaNameReplier(final ChangeCoaNameCommand changeCoaNameCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("ChangeCoaNameReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("ChangeCoaNameReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("ChangeCoaNameReplier : output : ({})", ObjectLogger.log(output));
