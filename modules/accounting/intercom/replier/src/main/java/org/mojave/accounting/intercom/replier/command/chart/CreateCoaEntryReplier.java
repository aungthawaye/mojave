...
@Component
public class CreateCoaEntryReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateCoaEntryReplier.class);
    ...
    public CreateCoaEntryReplier(final CreateCoaEntryCommand createCoaEntryCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("CreateCoaEntryReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("CreateCoaEntryReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("CreateCoaEntryReplier : output : ({})", ObjectLogger.log(output));
