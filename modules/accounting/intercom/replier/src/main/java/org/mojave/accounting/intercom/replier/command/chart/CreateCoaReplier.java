...
@Component
public class CreateCoaReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateCoaReplier.class);
    ...
    public CreateCoaReplier(final CreateCoaCommand createCoaCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("CreateCoaReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("CreateCoaReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("CreateCoaReplier : output : ({})", ObjectLogger.log(output));
