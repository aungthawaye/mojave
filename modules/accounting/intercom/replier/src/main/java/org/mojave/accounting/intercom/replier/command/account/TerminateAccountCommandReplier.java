...
@Component
public class TerminateAccountCommandReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(TerminateAccountCommandReplier.class);
    ...
    public TerminateAccountCommandReplier(final TerminateAccountCommand terminateAccountCommand,
        ...
        this.connection.createDispatcher(this::handle).subscribe(TerminateAccountCommand.SUBJECT_NAME);
    }
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("TerminateAccountCommandReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            final var input = this.objectMapper.readValue(
                message.getData(), TerminateAccountCommand.Input.class);

            LOGGER.info("TerminateAccountCommandReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("TerminateAccountCommandReplier : output : ({})", ObjectLogger.log(output));
