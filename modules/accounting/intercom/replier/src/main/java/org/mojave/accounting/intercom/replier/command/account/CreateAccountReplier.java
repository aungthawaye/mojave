...
@Component
public class CreateAccountReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateAccountReplier.class);
    ...
    public CreateAccountReplier(final CreateAccountCommand createAccountCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("CreateAccountReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("CreateAccountReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("CreateAccountReplier : output : ({})", ObjectLogger.log(output));
