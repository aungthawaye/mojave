...
@Component
public class DeactivateFlowDefinitionReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeactivateFlowDefinitionReplier.class);
    ...
    public DeactivateFlowDefinitionReplier(final DeactivateFlowDefinitionCommand deactivateFlowDefinitionCommand,
        ...
        this.connection.createDispatcher(this::handle).subscribe(DeactivateFlowDefinitionCommand.SUBJECT_NAME);
    }
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("DeactivateFlowDefinitionReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            final var input = this.objectMapper.readValue(
                message.getData(), DeactivateFlowDefinitionCommand.Input.class);

            LOGGER.info("DeactivateFlowDefinitionReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("DeactivateFlowDefinitionReplier : output : ({})", ObjectLogger.log(output));
