...
@Component
public class ActivateAccountReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActivateAccountReplier.class);
    ...
    public ActivateAccountReplier(final ActivateAccountCommand activateAccountCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("ActivateAccountReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("ActivateAccountReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("ActivateAccountReplier : output : ({})", ObjectLogger.log(output));
