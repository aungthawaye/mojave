...
@Component
public class CreateFlowDefinitionCommandReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateFlowDefinitionCommandReplier.class);
    ...
    public CreateFlowDefinitionCommandReplier(final CreateFlowDefinitionCommand createFlowDefinitionCommand,
        ...
        this.connection.createDispatcher(this::handle).subscribe(CreateFlowDefinitionCommand.SUBJECT_NAME);
    }
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("CreateFlowDefinitionCommandReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            final var input = this.objectMapper.readValue(
                message.getData(), CreateFlowDefinitionCommand.Input.class);

            LOGGER.info("CreateFlowDefinitionCommandReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("CreateFlowDefinitionCommandReplier : output : ({})", ObjectLogger.log(output));
