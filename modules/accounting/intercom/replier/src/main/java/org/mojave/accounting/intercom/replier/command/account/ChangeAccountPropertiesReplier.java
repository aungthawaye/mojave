...
@Component
public class ChangeAccountPropertiesReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeAccountPropertiesReplier.class);
    ...
    public ChangeAccountPropertiesReplier(final ChangeAccountPropertiesCommand changeAccountPropertiesCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("ChangeAccountPropertiesReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("ChangeAccountPropertiesReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("ChangeAccountPropertiesReplier : output : ({})", ObjectLogger.log(output));
