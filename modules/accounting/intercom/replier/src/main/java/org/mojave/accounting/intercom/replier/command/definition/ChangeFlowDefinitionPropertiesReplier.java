...
@Component
public class ChangeFlowDefinitionPropertiesReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeFlowDefinitionPropertiesReplier.class);
    ...
    public ChangeFlowDefinitionPropertiesReplier(final ChangeFlowDefinitionPropertiesCommand changeFlowDefinitionPropertiesCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("ChangeFlowDefinitionPropertiesReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("ChangeFlowDefinitionPropertiesReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("ChangeFlowDefinitionPropertiesReplier : output : ({})", ObjectLogger.log(output));
