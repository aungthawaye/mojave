...
package org.mojave.accounting.intercom.replier.command.ledger;
...
@Component
public class PostLedgerFlowReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(PostLedgerFlowReplier.class);
    ...
    public PostLedgerFlowReplier(final PostAccountingFlowCommand postAccountingFlowCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("PostLedgerFlowReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("PostLedgerFlowReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("PostLedgerFlowReplier : output : ({})", ObjectLogger.log(output));
