...
@Component
public class CreateFlowDefinitionReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateFlowDefinitionReplier.class);
    ...
    public CreateFlowDefinitionReplier(final CreateFlowDefinitionCommand createFlowDefinitionCommand,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("CreateFlowDefinitionReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("CreateFlowDefinitionReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("CreateFlowDefinitionReplier : output : ({})", ObjectLogger.log(output));
