...
package org.mojave.accounting.intercom.producer.command.ledger;
...
@Service
public class PostLedgerFlowProducer {

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public PostLedgerFlowProducer(final Connection connection,
