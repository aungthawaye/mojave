package org.mojave.accounting.ledger.mysql;
...
public class MySqlLedgerIT {
    ...
    public void createLedgerBalance_shouldInsert_whenAccountIdNotTaken() throws Exception {
        ...
        var ledgerBalance = new Ledger.LedgerBalance(
    ...
    @Test
    @SuppressWarnings("unchecked")
    public void createLedgerBalance_shouldThrowException_whenAccountIdAlreadyTaken()
        throws Exception {
        // Arrange
        var accountId = new AccountId(1L);
        var ledgerBalance = new Ledger.LedgerBalance(
        ...
        // Act & Assert
        assertThrows(
            Ledger.AccountIdAlreadyTakenException.class, () -> {
                ledger.createLedgerBalance(ledgerBalance);
            });
