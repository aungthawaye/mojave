...
package org.mojave.accounting.contract.command.ledger;
...
public interface PostLedgerFlowCommand {
    ...
    String SUBJECT_NAME = "sub-accounting.post-ledger-flow-command";

    String TOPIC_NAME = "tp-accounting.post-ledger-flow-command";
