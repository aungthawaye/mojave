...
package org.mojave.accounting.contract.exception.ledger;
...
public class OverdraftLimitReachedInAccountException extends CheckedDomainException {
    ...
    public OverdraftLimitReachedInAccountException(final AccountCode accountCode,
                                                   final Side side,
    ...
    public static OverdraftLimitReachedInAccountException from(final Map<String, String> extras) {
        ...
        return new OverdraftLimitReachedInAccountException(
