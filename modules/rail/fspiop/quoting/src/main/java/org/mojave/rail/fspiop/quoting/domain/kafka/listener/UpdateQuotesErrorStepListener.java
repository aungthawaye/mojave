...
public class UpdateQuotesErrorStepListener {
    ...
    @KafkaListener(
        topics = TopicNames.UPDATE_QUOTES_ERROR_STEP,
        containerFactory = LISTENER_CONTAINER_FACTORY,
        groupId = GROUP_ID)
    public void handle(UpdateQuotesErrorStep.Input input, Acknowledgment ack) {
