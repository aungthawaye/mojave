...
public class UpdateQuotesResponseStepListener {
    ...
    @KafkaListener(
        topics = TopicNames.UPDATE_QUOTES_RESPONSE_STEP,
        containerFactory = LISTENER_CONTAINER_FACTORY,
        groupId = GROUP_ID)
    public void handle(UpdateQuotesResponseStep.Input input, Acknowledgment ack) {
