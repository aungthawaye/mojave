...
@Service
public class UpdateQuotesErrorStepProducer {

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public UpdateQuotesErrorStepProducer(final Connection connection,
    ...
    public void initialize() {
        ...
        JetStreamConfigurer.ensureStream(
            ...
            UpdateQuotesErrorStep.TOPIC_NAME);
    }

    public void publish(final UpdateQuotesErrorStep.Input input) {

        NatsPublisher.publish(
            this.connection, UpdateQuotesErrorStep.TOPIC_NAME, input,
            this.objectMapper);
    }
