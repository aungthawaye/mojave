...
@Service
public class RollbackReservationStepProducer {

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public RollbackReservationStepProducer(final Connection connection, final ObjectMapper objectMapper) {
    ...
    public void initialize() {
        ...
        JetStreamConfigurer.ensureStream(
            ...
            RollbackReservationStep.TOPIC_NAME);
    }
