...
@Service
public class AbortTransferStepProducer {

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public AbortTransferStepProducer(final Connection connection, final ObjectMapper objectMapper) {
    ...
    public void initialize() {
        ...
        JetStreamConfigurer.ensureStream(
            ...
            AbortTransferStep.TOPIC_NAME);
    }

    public void publish(final AbortTransferStep.Input input) {

        NatsPublisher.publish(
            this.connection, AbortTransferStep.TOPIC_NAME, input,
            this.objectMapper);
