...
package org.mojave.wallet.producer;
...
import org.mojave.wallet.producer.publisher.FulfilPositionsPublisher;
import org.mojave.wallet.producer.publisher.RollbackReservationPublisher;
...
@ComponentScan(basePackages = {"org.mojave.wallet.producer"})
@Import(value = {MiscConfiguration.class})
public class WalletProducerConfiguration {

    @Bean
    @Qualifier(FulfilPositionsPublisher.QUALIFIER)
    public KafkaTemplate<String, FulfilPositionsCommand.Input> fulfilPositionsKafkaTemplate(
        @Qualifier(
            FulfilPositionsPublisher.QUALIFIER)
        ProducerFactory<String, FulfilPositionsCommand.Input> producerFactory) {
    ...
    public interface RequiredSettings {
        ...
        WalletProducerConfiguration.ProducerSettings walletProducerSettings();
