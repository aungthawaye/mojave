...
package org.mojave.wallet.producer.publisher;
...
public class RollbackReservationPublisher {
    ...
    public RollbackReservationPublisher(@Qualifier(QUALIFIER)
                                        KafkaTemplate<String, RollbackReservationCommand.Input> kafkaTemplate) {
