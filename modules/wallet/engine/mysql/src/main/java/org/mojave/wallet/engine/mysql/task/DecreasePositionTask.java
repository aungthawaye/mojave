...
public final class DecreasePositionTask {

    private DecreasePositionTask() {
    ...
    public static WalletEngine.PositionHistory execute(final JdbcTemplate jdbcTemplate,
        ...
        throws WalletEngine.NoPositionUpdateException {
        ...
        try {
            ...
            return jdbcTemplate.execute((ConnectionCallback<WalletEngine.PositionHistory>) con -> {
                ...
                try (
                    ...
                    throw new RuntimeException(new WalletEngine.NoPositionUpdateException(
                        transactionId));
                }
            });
