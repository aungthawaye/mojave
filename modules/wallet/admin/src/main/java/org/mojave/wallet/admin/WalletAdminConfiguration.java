...
package org.mojave.wallet.admin;
...
@EnableAsync
@ComponentScan(basePackages = "org.mojave.wallet.admin.controller")
@Import(
    value = {
...
public final class WalletAdminConfiguration extends JsonWebMvcConfigurationSupport {
