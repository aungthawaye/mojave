...
@Service
public class WithdrawBalanceCommandHandler implements WithdrawBalanceCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(
        WithdrawBalanceCommandHandler.class);

    private final WalletEngine walletEngine;

    private final WalletCache walletCache;

    public WithdrawBalanceCommandHandler(final WalletEngine walletEngine,
    ...
    public Output execute(final Input input)
        ...
        try {
            ...
            final var history = this.walletEngine.withdrawBalance(
                balanceUpdateId, input.transactionId(), input.transactionAt(), walletId,
