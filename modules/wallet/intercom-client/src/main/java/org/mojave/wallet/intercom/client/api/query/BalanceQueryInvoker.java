...
package org.mojave.wallet.intercom.client.api.query;
...
public class BalanceQueryInvoker implements BalanceQuery {
    ...
    private final WalletIntercomService.BalanceQuery balanceQuery;

    private final ObjectMapper objectMapper;

    public BalanceQueryInvoker(final WalletIntercomService.BalanceQuery balanceQuery,
