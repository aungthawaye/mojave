...
package org.mojave.wallet.consumer;
...
@Import(
    value = {
        ...
        WalletConsumerDependencies.class,
        WalletConsumerSettings.class})
public class WalletConsumerApplication {

    private final static Logger LOGGER = LoggerFactory.getLogger(WalletConsumerApplication.class);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        var context = new AnnotationConfigApplicationContext(WalletConsumerApplication.class);
