...
- Inside `WalletAdminService.WalletCommand`, create the methods according to the
  controllers inside
  `org.mojave.wallet.admin.controller.api.command.account`
...
- Inside `WalletAdminService.PositionCommand`, create the methods according to
  ...
  `org.mojave.wallet.admin.controller.api.command.chart`
...
- Create Invoker classes in `org.mojave.wallet.admin.client.api.command`
  and its sub-packages, and also in
  `org.mojave.wallet.admin.client.api.query`.
