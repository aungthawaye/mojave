...
package org.mojave.wallet.admin.client.service;
...
import org.mojave.wallet.contract.command.balance.CreateBalanceCommand;
import org.mojave.wallet.contract.command.balance.DepositFundCommand;
import org.mojave.wallet.contract.command.balance.ReverseWithdrawCommand;
import org.mojave.wallet.contract.command.balance.WithdrawFundCommand;
import org.mojave.wallet.contract.command.position.CommitReservationCommand;
import org.mojave.wallet.contract.command.position.CreatePositionCommand;
...
public interface WalletAdminService {
    ...
    interface BalanceCommand {
        ...
        @POST(MODULE_PREFIX + "/balances/create-balance")
    ...
    interface PositionCommand {
        ...
        @POST(MODULE_PREFIX + "/positions/create-position")
