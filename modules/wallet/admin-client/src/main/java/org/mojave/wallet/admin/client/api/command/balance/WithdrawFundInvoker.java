...
public class WithdrawFundInvoker implements WithdrawFundCommand {
    ...
    public WithdrawFundInvoker(final WalletAdminService.BalanceCommand balanceCommand,
    ...
    public Output execute(final Input input)
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.balanceCommand.withdrawFund(input),
            ...
            if (decodedErrorResponse instanceof MojaveErrorResponse errorResponse) {
                ...
                switch (throwable) {
                    ...
                    case InsufficientBalanceException e2 -> throw e2;
