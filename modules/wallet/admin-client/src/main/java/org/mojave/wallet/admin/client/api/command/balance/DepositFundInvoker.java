...
package org.mojave.wallet.admin.client.api.command.balance;

import org.mojave.component.misc.error.MojaveErrorResponse;
import org.mojave.component.misc.exception.UncheckedDomainException;
import org.mojave.component.retrofit.RetrofitService;
import org.mojave.wallet.admin.client.service.WalletAdminService;
...
@Component
public class DepositFundInvoker implements DepositFundCommand {

    private final WalletAdminService.BalanceCommand balanceCommand;

    private final ObjectMapper objectMapper;

    public DepositFundInvoker(final WalletAdminService.BalanceCommand balanceCommand,
    ...
    public Output execute(final Input input) throws NoBalanceUpdateForTransactionException {
        ...
        try {
            ...
            return RetrofitService.invoke(
                this.balanceCommand.depositFund(input),
