...
@Component
public class DepositBalanceReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(DepositBalanceReplier.class);
    ...
    public DepositBalanceReplier(final DepositBalanceCommand command,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("DepositBalanceReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("DepositBalanceReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("DepositBalanceReplier : output : ({})", ObjectLogger.log(output));
