...
@Component
public class RollbackReservationReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(RollbackReservationReplier.class);
    ...
    public RollbackReservationReplier(final RollbackReservationCommand command,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("RollbackReservationReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("RollbackReservationReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("RollbackReservationReplier : output : ({})", ObjectLogger.log(output));
