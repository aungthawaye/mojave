...
@Component
public class ReservePositionReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(ReservePositionReplier.class);
    ...
    public ReservePositionReplier(final ReservePositionCommand command,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("ReservePositionReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("ReservePositionReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("ReservePositionReplier : output : ({})", ObjectLogger.log(output));
