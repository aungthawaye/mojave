...
@Component
public class FulfilPositionsCommandReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(FulfilPositionsCommandReplier.class);
    ...
    public FulfilPositionsCommandReplier(final FulfilPositionsCommand command,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("FulfilPositionsCommandReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("FulfilPositionsCommandReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("FulfilPositionsCommandReplier : output : ({})", ObjectLogger.log(output));
