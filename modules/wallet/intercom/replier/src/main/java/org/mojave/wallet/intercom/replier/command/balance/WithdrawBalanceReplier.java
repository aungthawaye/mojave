...
@Component
public class WithdrawBalanceReplier {

    private static final Logger LOGGER = LoggerFactory.getLogger(WithdrawBalanceReplier.class);
    ...
    public WithdrawBalanceReplier(final WithdrawBalanceCommand command,
    ...
    private void handle(final Message message) {
        ...
        if (replyTo == null || replyTo.isBlank()) {
            LOGGER.warn("WithdrawBalanceReplier : reply subject is missing.");
            return;
        }
        ...
        try {
            ...
            LOGGER.info("WithdrawBalanceReplier : input: ({})", ObjectLogger.log(input));
            ...
            LOGGER.info("WithdrawBalanceReplier : output : ({})", ObjectLogger.log(output));
