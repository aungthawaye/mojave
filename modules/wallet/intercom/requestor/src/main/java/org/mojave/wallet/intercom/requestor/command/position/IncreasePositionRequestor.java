...
@Component
public class IncreasePositionRequestor implements IncreasePositionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(IncreasePositionRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public IncreasePositionRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("IncreasePositionRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("IncreasePositionRequestor : output : ({})", ObjectLogger.log(output));
