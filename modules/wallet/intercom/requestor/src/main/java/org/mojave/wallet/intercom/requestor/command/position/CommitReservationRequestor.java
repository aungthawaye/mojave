...
@Component
public class CommitReservationRequestor implements CommitReservationCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(CommitReservationRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public CommitReservationRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("CommitReservationRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("CommitReservationRequestor : output : ({})", ObjectLogger.log(output));
