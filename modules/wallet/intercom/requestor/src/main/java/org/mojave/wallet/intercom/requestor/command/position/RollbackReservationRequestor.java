...
@Component
public class RollbackReservationRequestor implements RollbackReservationCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(RollbackReservationRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public RollbackReservationRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("RollbackReservationRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("RollbackReservationRequestor : output : ({})", ObjectLogger.log(output));
