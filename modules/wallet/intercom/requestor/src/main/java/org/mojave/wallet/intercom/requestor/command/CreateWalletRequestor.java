package org.mojave.wallet.intercom.requestor.command;
...
@Component
public class CreateWalletRequestor implements CreateWalletCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(CreateWalletRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public CreateWalletRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("CreateWalletRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("CreateWalletRequestor : output : ({})", ObjectLogger.log(output));
