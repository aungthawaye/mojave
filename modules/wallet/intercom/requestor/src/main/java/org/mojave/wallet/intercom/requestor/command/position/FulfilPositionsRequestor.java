...
@Component
public class FulfilPositionsRequestor implements FulfilPositionsCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(FulfilPositionsRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public FulfilPositionsRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("FulfilPositionsRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("FulfilPositionsRequestor : output : ({})", ObjectLogger.log(output));
