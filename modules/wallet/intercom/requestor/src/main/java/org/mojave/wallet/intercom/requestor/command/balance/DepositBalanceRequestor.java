...
@Component
public class DepositBalanceRequestor implements DepositBalanceCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(DepositBalanceRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public DepositBalanceRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("DepositBalanceRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("DepositBalanceRequestor : output : ({})", ObjectLogger.log(output));
