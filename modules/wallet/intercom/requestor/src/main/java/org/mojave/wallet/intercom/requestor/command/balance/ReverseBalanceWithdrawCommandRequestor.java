...
public class ReverseBalanceWithdrawCommandRequestor implements ReverseBalanceWithdrawCommand {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ReverseBalanceWithdrawCommandRequestor.class);
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("ReverseBalanceWithdrawCommandRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("ReverseBalanceWithdrawCommandRequestor : output : ({})", ObjectLogger.log(output));
