...
@Component
public class WithdrawBalanceRequestor implements WithdrawBalanceCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(WithdrawBalanceRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public WithdrawBalanceRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("WithdrawBalanceRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("WithdrawBalanceRequestor : output : ({})", ObjectLogger.log(output));
