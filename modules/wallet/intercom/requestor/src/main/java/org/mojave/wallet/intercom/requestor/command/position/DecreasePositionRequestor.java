...
@Component
public class DecreasePositionRequestor implements DecreasePositionCommand {

    private static final Logger LOGGER = LoggerFactory.getLogger(DecreasePositionRequestor.class);

    private final Connection connection;

    private final ObjectMapper objectMapper;

    public DecreasePositionRequestor(final Connection connection,
    ...
    public Output execute(final Input input) {
        ...
        LOGGER.info("DecreasePositionRequestor : input: ({})", ObjectLogger.log(input));
        ...
        try {
            ...
            LOGGER.info("DecreasePositionRequestor : output : ({})", ObjectLogger.log(output));
