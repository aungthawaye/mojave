...
package org.mojave.wallet.intercom.controller.api.command.position;
...
public class IncreasePositionController {
    ...
    @ResponseBody
    public IncreasePositionCommand.Output execute(
        @Valid @RequestBody final IncreasePositionCommand.Input input) throws
