...
public class FxRatePairId extends LongId {
    ...
    @Component
    public static class ParamConverter implements Converter<String, FxRatePairId> {

        @Override
        public FxRatePairId convert(final @NonNull String source) {

            return new FxRatePairId(Long.parseLong(source));
        }
