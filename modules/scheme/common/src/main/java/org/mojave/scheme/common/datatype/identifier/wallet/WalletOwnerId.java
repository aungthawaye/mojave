...
public class WalletOwnerId extends EntityId<Long> {
    ...
    public static class Deserializer extends ValueDeserializer<WalletOwnerId> {

        @Override
        public WalletOwnerId deserialize(JsonParser p, DeserializationContext ctx)
            ...
            try {
                return new WalletOwnerId(Long.parseLong(text));
