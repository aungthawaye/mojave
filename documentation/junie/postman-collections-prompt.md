Create Postman Collection for all the controllers inside this package `io.mojaloop.core.wallet.admin.controller`.

Follow the below guidelines:
- Scan the subpackages of `io.mojaloop.core.wallet.admin.controller` package. And create each subpackage as a folder in the collection.
